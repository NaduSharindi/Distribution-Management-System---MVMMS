						...
						<div class="col-lg-8">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<form:form role="form" action="MMSaddLine" method="post" modelAttribute="SaveLine">
									...
									<div class="msgSuccess">
										<c:out value="${SaveLine.name}"></c:out>
											...
											<form:input path="feederIdentification" type="text" id="otherFeederIdentification" name="otherFeederIdentification" class="form-control" style="visibility:hidden;"/>
        														...
        														<tr>
                												<td width="40%" style="text-align:left">
                												Feeder Identification 2
                												
                												</td>
                												<td width="60%" style="text-align:left">
																<form:select path="feeder2"  class="form-control" name="cmbFeederIdentification" id="cmbFederIdentification" onchange="changeFeederIdentification()">
													<form:option value="None" selected="selected">None </form:option>
													<form:option value="F01">F01</form:option>
													<form:option value="F02">F02</form:option>
													<form:option value="F03">F03</form:option>
											...
											<form:input path="feederIdentification" type="text" id="otherFeederIdentification" name="otherFeederIdentification" class="form-control" style="visibility:hidden;"/>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="name" type="text" class="form-control" id="txtCode" placeholder="Enter Gss Name"/>
																<span id="spnCode" class="label label-danger"></span>
