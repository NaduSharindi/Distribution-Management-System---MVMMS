													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
        														...
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/ViewScheduleAndReport?mode=TP' />" >Tapping details report</a></td>
        														
        														</tr>
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/viewSupport' />" >Inspection History report</a></td>
