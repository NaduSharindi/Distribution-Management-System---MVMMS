			...
			<%-- <jsp:include page="sections/userLevels.jsp" /> --%>
				...
				<div class="col-lg-12">		                                    
                        <div class="col-lg-9">
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li class="active"><span>Add Mv Pole</span></li>
                            </ol>
						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									...
									<form:form role="form" action="MMSaddmvpole" method="post" modelAttribute="SaveMVPole">
																...
																<form:select path="" onchange="findArea()" class="form-control" id="cmbSelectProvince" name="cmbSelectProvince">
																   ...
																   <form:options items="${SaveMVPole.provinceList}" /> 
																</form:select>
																...
																<form:select path="mvpole.area"  onchange="getGantryByArea();getCSC();" class="form-control" id="cmbSelectArea" name="cmbSelectArea">
																     <form:options items="${SaveMVPole.areaList}" />
																</form:select>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="mvpole.feederNo" class="form-control" id="cmbSelectFeeder" name="cmbSelectFeeder">
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="mvpole.poleNo" type="text" class="form-control" id="txtPoleNumber" placeholder="Enter Pole Number"/>
																<span id="spnPoleNumber" class="label label-danger"></span>
