													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
        														...
        														<td  style="text-align:left"   ><a href="<c:url value='/ViewInsEstDetail?nooftower=${summary[4]}&lineLength=${summary[3]}&id=${summary[0]}&dd=${dd}&province=${province}&area=${summary[1]}' />" >${summary[1]}</a></td>
