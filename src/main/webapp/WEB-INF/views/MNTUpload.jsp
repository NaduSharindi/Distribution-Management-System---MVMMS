			...
			<div class="row">
				...
				<div class="col-lg-12">		                                    
                        <div class="col-lg-9">
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li class="active"><span>Upload Tower Maintenance</span></li>
                            </ol>
                        </div>
										...
										<div class="main-box-body clearfix">
											<div class="table-responsive">
                                              <table class="table table-responsive" id="tblAreas">
													...
													<tbody>
																<form:form  method="post" action="uploadMNT" enctype="multipart/form-data" modelAttribute="model">
																 <table class="table table-responsive" id="tblProvinces">
																	<c:if test="${not empty model.mode}">
																<tr>
																<td colspan="2" class="msgSuccess" align="center"font color="blue">
													     	...
													     	<tr>
        														...
        														<%-- <tr>
                												<td width="30%" style="text-align:left">
                												<form:label path="cycle">Cycle</form:label>
                												</td>
                												<td width="70%" style="text-align:left">
                												<form:select  id="cycle" path ="cycle" onchange="">
