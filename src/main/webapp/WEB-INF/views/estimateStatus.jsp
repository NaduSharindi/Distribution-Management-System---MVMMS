 ...
 */ 
  ...
  $.ajax({
		...
		success : function(result) {
			...
			datavaluepie.addColumn('number', 'Number of Estimate');
			datavaluepie.addColumn('string', 'Status');
			datavaluepie.addColumn('string', 'Dept Id');
			 datavaluepie.addColumn('number', 'Status Number');
	            ...
	            $.ajax({
	    			...
	    			success : function(result) {
	    				...
	    				datavalue.addColumn('string', 'Estimate Number');
	    						...
	    						datavalue.addRows([[data[0],data[1],data[2],data[5],data[6],data[3],data[7],data[4]]]);
