...
<div class="main">
        ...
        <td >
        	<div class="up">
        	<div class="wrapper">
        		<h4 id="topic"> Substation data </h4>
...
<br>
                ...
                <div class = "input_field">
				<label> Transformer Size: <br> (if chose 'Other') <br> &nbsp&nbsp *Optional </label>
				...
				<label> SIN Number: </label>
				   <input type="number" name="sin" id="quantity">
				</div>
                <br>
