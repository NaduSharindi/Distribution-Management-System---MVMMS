							...
							<div class="row">
								<div class="col-xs-12">
									<header id="login-header">
										<div id="login-logo">
											<img src="<c:url value="/resources/img/PNGImages/png.png"/>"/>
											<p>PNG User Login</p>
											
										</div>
									</header>
									<div id="login-box-inner">
										<form:form role="form" name="loginForm" id="loginForm" method="POST" action="pngLogin">
											...
											<div class="row">
												<div class="col-xs-12">
													<button type="submit" class="btn btn-success col-xs-12" href="javascript:formSubmit()">Login</button>
												</div>
											</div>
