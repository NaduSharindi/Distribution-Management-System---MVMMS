...
function confirmRequest(id){
	...
	$.ajax({
			type : 'GET',
			url : "/MMS/confirmRequest/" +id+ "/"+permit_no +"/"+incharge_es+"/"+altsup+"/",
			data : {},
			contentType : "application/json; charset=utf-8",
			success : function(data) {
...
function forwardRequest(id){
	...
	$.ajax({
		type : 'GET',
		url : "/MMS/forwardRequest/" +id+ "/",
		data : {},
		contentType : "application/json; charset=utf-8",
		success : function(data) {
			alert("Succesfully forwaded to es...");
			window.location.reload();
...
function reScheduleRequest(id){
	...
	$.ajax({
		type : 'GET',
		url : "/MMS/reScheduleRequest/" +id+ "/" +reScheduleDate+ "/" +permit_no +"/"+incharge_es+"/"+altsup+"/",
		data : {},
		contentType : "application/json; charset=utf-8",
		success : function(data) {
			alert("Succesfully done...Email-SMS is succesfully sent to PHM ");
													...
													<c:set var="myVar" value="${model.mode}" />
													   ...
													   <table class="main-table" id="tblAdmin">
														...
														<c:when test="${submitType=='FWD'}">
														    ...
														    <th class="text-center">Section to be interrupted</th>
														...
														<c:when test="${submitType=='APP'}">
															...
															<th class="text-center">Permit Number</th>
															<th class="text-center">Incharge ES</th>
															<th class="text-center">Alternative Supply Arrangement</th>
														...
														<c:when test="${submitType=='PROVINCE'}">
																<tr>
															<th class="text-center">Interruption Request No</th>
															<th class="text-center">Area</th>
															<th class="text-center">Date </th>
...
<c:when test="${submitType=='FWD'}">
																...
																<td style="text-align:left"><textarea rows="3" cols="60" class="form-control" disabled>${email.req1}</textarea></td>
																<td style="text-align:left"><textarea rows="3" cols="60" class="form-control" disabled>${email.req2}</textarea></td>
																<%-- <td style="text-align:center"><form:input style="text-align:center" type="date" id="datepicker1_${email.approvalId}"  path = "intRequestObj.rescheduleDate" class="form-control"></form:input></td>
																<td style="text-align:center"><form:input style="text-align:center" type="text" id="permit_no_${email.approvalId}" path="intRequestObj.permitNo" class="form-control"></form:input></td>
																<td style="text-align:center"><form:input style="text-align:center" type="text" id="incharge_es_${email.approvalId}" path="intRequestObj.inchargeEs" class="form-control"></form:input></td>
																 --%>
																<td style="text-align:left"> <form:select id="incharge_es_${email.approvalId}" path="intRequestObj.inchargeEs" class="form-control"  style="background-color: #94cb71; border-radius: 5px;">
																...
																<%-- <td><button type='button' class='btn btn-warning' onclick="forwardedToEsRequest("${email.approvalId}")">Forwarded to ES</button></td>
																 --%><td><button type='button' class='btn btn-info' onclick='forwardRequest("${email.approvalId}")'>Forward</button></td>
																<%-- <td><button type='button' class='btn btn-warning' onclick='notConfirmRequest("${email.approvalId}")'>Not Approve</button></td>
...
<c:when test="${submitType=='APP'}">
															...
															--%>	<td style="text-align:center"><form:input style="text-align:center" type="text" id="permit_no_${email.approvalId}" path="intRequestObj.permitNo" class="form-control"></form:input></td>
																...
																<td style="text-align:left"> <form:select id="incharge_es_${email.approvalId}" path="intRequestObj.inchargeEs" class="form-control"  style="background-color: #94cb71; border-radius: 5px;">
																	 ...
																	 <td style="text-align:left"><textarea rows="3" cols="60" id="altsup_${email.approvalId}" ></textarea></td>
																
																<td><button type='button' class='btn btn-warning' onclick="window.location.href='downloadInterruptionReq?id=${email.approvalId}'">Letter</button></td>
																<td><button type='button' class='btn btn-info' onclick='confirmRequest("${email.approvalId}")'>Approve</button></td> 
...
<c:when test="${submitType=='NAP'}">
																...
																<%-- <td><button type='button' class='btn btn-warning' onclick="forwardedToEsRequest("${email.approvalId}")">Forwarded to ES</button></td>
																 --%><%-- <td><button type='button' class='btn btn-info' onclick='confirmRequest("${email.approvalId}")'>Approve</button></td> --%> 
																<%--  <td><button type='button' class='btn btn-warning' onclick='notConfirmRequest("${email.approvalId}")'>Not Approve</button></td>
																 --%><td><button type='button' class='btn btn-info' onclick='notConfirmRequest("${email.approvalId}")'>Not Approve</button></td>
...
<c:when test="${submitType=='VIW'}">
																...
																<td style="text-align:left"><textarea rows="3" cols="60" id="altsup_${email.approvalId}" ></textarea></td>
																 --%><%-- <td><input  type="file" name="file1" id="file1_${email.approvalId}" ></td>
																 --%>
																 <td><button type='button' class='btn btn-warning' onclick='loadNetwork("${email.approvalId}")'>Network View</button></td>
																...
																<td><button type='button' class='btn btn-warning' onclick='notConfirmRequest("${email.approvalId}")'>Not Approve</button></td>
																<td><button type='button' class='btn btn-info' onclick='reScheduleRequest("${email.approvalId}")'>Reschedule</button></td>
																 --%><td><button type='button' class='btn btn-info' onclick="window.location.href='downloadIntImgReq?id=${email.approvalId}&seq=1'">IMG-1</button></td>
																<td><button type='button' class='btn btn-warning' onclick="window.location.href='downloadIntImgReq?id=${email.approvalId}&seq=2'">IMG-2</button></td>
																<td><button type='button' class='btn btn-info' onclick="window.location.href='downloadIntImgReq?id=${email.approvalId}&seq=3'">IMG-3</button></td>
																<td><button type='button' class='btn btn-warning' onclick="window.location.href='downloadIntImgReq?id=${email.approvalId}&seq=4'">IMG-4</button></td>
																<td><button type='button' class='btn btn-info' onclick="window.location.href='downloadIntImgReq?id=${email.approvalId}&seq=5'">IMG-5</button></td>
