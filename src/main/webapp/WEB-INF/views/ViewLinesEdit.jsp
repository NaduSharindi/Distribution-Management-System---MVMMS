	...
	function showLines()
		...
		var area = $('#cmbSelectArea').find(":selected").attr("value");
		 alert('area'+area);
		             ...
		             ({
		                     type: 'GET',
		                     url: '/MMS/findLineByAreaStatus/' +area +'/2',
		                     data: {},
		                         ...
		                         for (var i = 0; i < response.length; i++) {
		                             ...
		                             tr = $('<tr/>');
		                                ...
		                                tr.append("<td> <select id=status"+item.id+" disabled >"
		                                		+"<option value="+item.status+" selected=selected>In bulk</option>"
...
*/
	...
	function sendForValidation() 
    {
		...
		var area = $('#cmbSelectArea').find(":selected").attr("value");
	    var url = "/MMS/updateLineStatus/"+area+"/2";
         $.ajax({
        	type: "GET",
            url : url,
            success : function(response) {
					...
					<div class="row">
								...
								<!-- 	<tr>
											...
											<header class="main-box-header clearfix">
												<button type="button" class="btn btn-info" onclick="sendForValidation()">Send for Validation</button>
												</header>
