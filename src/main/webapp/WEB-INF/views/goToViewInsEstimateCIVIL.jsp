...
<script type="text/javascript">
	...
	function generateEstimate(){
		...
		var cycleName = cycle.options[cycle.selectedIndex].value;
		var userIdName = userId.options[userId.selectedIndex].value;
		var appName = appId.options[appId.selectedIndex].value;
		...
		if (areaName === "")
		{
			...
			alert("ES may not be empty");
			event.preventDefault();
			return false;
		}else if (appName === ""){
			alert("Applicant may not be empty");
			event.preventDefault();
			return false;
		}
		else if (cycleName === ""){
		...
		//alert(areaName + cycleName+userIdName+appName);
		$
		.ajax({
			type : 'GET',
			url : "/MMS/goToViewInsEstimateSCIVIL?area=" + areaName + "&cycle="+cycleName +"&es="+userIdName+"&id="+appName,
			data : {},
			contentType : "application/json",
			success : function(data) {
				
				alert("Estimate is successfully created "+ data);	
			}
		});
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="col-lg-9">
								<ol class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active"><span>COLD LINE CIVIL ESTIMATE</span></li>
								</ol>
							</div>
								...
								<div class="main-box-body clearfix">
									<div class="table-responsive">
										<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" action="saveCIVIL"
										...
										<c:out value="${model.mode}"></c:out>
													...
													<table class="table table-striped table-bordered table-sm " id="tblProvinces">
														...
														<tr>
															...
															<td width="70%" style="text-align: left"><form:select
																	id="appId" path="applicant.idNo" onchange="" style="width:50%; background-color: #FFFFF; border-radius: 5px;">
																	<form:option value="" label="ALL" />
														...
														<td width="30%" style="text-align: left">Cycle</td>
															<td width="70%" style="text-align: left"><form:select
																	id="cycle" path="cycle" onchange="" style="width:50%; background-color: #FFFFF; border-radius: 5px;">
																	<form:option value="" label="ALL" />
...
<%-- <tr>
													...
													<c:if test="${canGO !='1'}">
														<!-- <br>
														<h2 class="pull-left">
															<strong>Select Lines To Estimate</strong>
														</h2>
														<br>
														<br>
															 ...
															 --><tbody>
																...
																<c:forEach var="Line" items="${model.lineListEdit}">
																	<tr>
																		...
																		<td><input type="text" id="id_${Line.code}"
													...
													<c:if test="${canGO =='1'}">
														<tr>
															<td style="text-align: left"><input
										class="btn btn-success" type="submit" 
																	name="actionButton" value="Generate"></input></td>
														</tr>
													</c:if>
													<%-- <c:if test="${canGO =='2'}">
														<tr>
