...
function drawDashboard() {
	 // alert("hii");
   	  $.ajax({
			type : 'GET',
			url : "/MMS/getRequestStatusCountByTypeES",
			data : {},
			...
			success : function(result) {
				...
				for (var i = 0; i < result.length; i++) {
						var data = result[i];
						datavaluepie.addRows([[data[1],data[0]]]);
				}
		        ...
		        var donutRangeSlider2 = new google.visualization.ControlWrapper({
		          ...
		          'options': {
		        	'filterColumnLabel': 'Electrical Superintendent'
		          }
		        });
										...
										<div class="wrimagecard wrimagecard-topimage">
											<div class="wrimagecard-topimage_header"
												...
												<h4>
															...
															<strong>Order Card Request ES Summary </strong>
