	...
	function showLines()
		...
		var area = $('#cmbSelectArea').find(":selected").attr("value");
		 alert('area'+area);
		             ...
		             ({
		                     type: 'GET',
		                     url: '/MMS/findLineByAreaStatus/' +area +'/4',
		                     data: {},
		                     ...
		                     success: function(response) 
		                     {
		                         ...
		                         for (var i = 0; i < response.length; i++) {
		                             ...
		                             tr = $('<tr/>');
		                             	...
		                             	tr.append("<td> <input type=text id=lineType"+item.id+"  value="+lineType+" disabled ></input></td>");
...
*/
	...
	function sendForValidation() 
    {
		...
		var area = $('#cmbSelectArea').find(":selected").attr("value");
	    var url = "/MMS/updateLineStatusee/"+area+"/4";
         $.ajax({
        	type: "GET",
            url : url,
            success : function(response) {
					...
					<div class="row">
								...
								<!-- 	<tr>
											...
											<header class="main-box-header clearfix">
												<button type="button" class="btn btn-info" onclick="sendForValidation()">Approve</button>
												</header>
