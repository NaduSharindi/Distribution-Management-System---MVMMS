...
function removeRequest(id){
    ...
    function isClickApprove(id,costCenter){
    	...
    	if(strUser.includes('NONE')){
    		...
    		var r = confirm("You are going to send the estimate number :" + id+ " for approval \n\nAre you sure?");
  		if (r == true) {
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-9">
								<ol class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active"><span>Reallocate Responsible EE</span></li>
...
<div class="upnew">
            	<div class="wrapper">
			<div class = "form">
													<form:form role="form" action="approveEstimateMMSES"
    ...
    <table style = "font-size: 12px;" id= "myTable" class="display table" width="100%">
        ...
        <c:set var="count" value="0" scope="page" />
															...
															<c:forEach var="job" items="${model.listPcesthttModel}"  varStatus="status">
																...
																<td><button id = "saveBtn_${job.estimateNo}"  type="submit" class="button button3"  onclick='isClickApprove("${job.estimateNo}","${job.deptId}")' ><i class="glyphicon glyphicon-ok"></i></button></td> 
