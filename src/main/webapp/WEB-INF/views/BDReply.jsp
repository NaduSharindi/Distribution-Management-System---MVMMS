...
function myFunctionee() {
   ...
   <table id="example" class="table table-striped table-bordered table-sm " style="width:100%">
     ...
     <c:if test="${sessionScope.loggedUserRole=='ES'}">
	<th class="th-sm" style = "background-color:DarkGrey">Generate Estimate</th>
    </c:if>
    
    <th class="th-sm" style = "background-color:DarkGrey">View Letter</th>
    
        <th class="th-sm" style = "background-color:DarkGrey"> Request No</th>
        <th class="th-sm" style = "background-color:DarkGrey">Requesting Branch</th>
       <!--  <th class="th-sm" style = "background-color:DarkGrey">Remarks</th>
        --> <th class="th-sm" style = "background-color:DarkGrey">Line Name</th>
        ...
        <th class="th-sm" style = "background-color:DarkGrey">Date and Time</th>
    ...
    <c:forEach var="email" items="${model.unReadInspectionReq}">
																...
																<!-- <td><textarea id="w3review" name="w3review" rows="4" cols="20"></textarea></td>
																 --><td>${email.esName}</td>
																...
																<td class="col-md-3" style="overflow-wrap:break-word;text-overflow:clip;">${email.req2}</td>
