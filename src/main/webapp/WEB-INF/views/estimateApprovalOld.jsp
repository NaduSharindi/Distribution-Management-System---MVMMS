...
/*  $.ajax({
		...
		success : function(result) {
			...
			datavaluepie.addColumn('string', 'Dept Id');
			datavaluepie.addColumn('number', 'Status No');
			...
			for (var i = 0; i < result.length; i++) {
					...
					datavaluepie.addRows([[data[1], data[0],str,data[2],data[3]]]);
			}
	    ...
	    /*    var table = new google.visualization.ChartWrapper({
	        ...
	        function selectHandler() {
	         ...
	         //  alert('The user selected ' + deptId + "eeee"+status);
	            ...
	            $.ajax({
	    			type : 'GET',
	    			url : "/MMS/getEstimateDetail/" +deptId+"/"+status+"/" ,
	    			data : {},
	    			contentType : "application/json; charset=utf-8",
	    			success : function(result) {
	    				var datavalue = new google.visualization.DataTable();
...
<tr>
<td><input type="text" id ="txtEstNo" Value="Estimate No to be Approved" class="form-control" disabled/></td>
...
<td><input type="submit" id ="btnViewPrint" Value="View Estimate Print Out" class="btn btn-success" onClick="viewPrint()" /></td>
				...
				<br><br>
									...
									<div class="row">
										...
										<div id="filter_div2" style="height: 50px"></div>
