...
<style type="text/css">
body {
   background-image: url('https://images.livemint.com/img/2021/04/02/1600x900/6b68e304-e216-11ea-8bff-6706f195ca7a_1597860894919_1597860936478_1617378168868.jpg');
   color: #FFFFFF;
...
<div class="login-wrapper">
 ...
 <form:form role="form" name="loginForm" class="form" method="GET" action="newpage">
										<img src="<c:url value="/resources/img/CEBImages/logo_ko.png"/>" alt="">
                                        <h2>Energy Management Login</h2>	
