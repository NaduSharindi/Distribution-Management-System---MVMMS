...
function searchStatus(key){
	  switch (key) {
		case "20":
			return "Removed";			 
		case "6":
			return "Sent by ES PHM/Pending at EE PHM";			 
		case "95":
			return "Sent by EE PHM/Pending at Area/Planning CE/Control Center EE";	
		case "96":
			return "Recommend";	
		case "97":
   	  ...
   	  $.ajax({
			...
			success : function(result) {
				...
				for (var i = 0; i < result.length; i++) {
						...
						if(data[2]=="95"){
							if(data[3]=="1"){
								status ="Sent by EE PHM/Pending at Area Engineer";
							}else if(data[3]=="2"){
								status ="Sent by EE PHM/Pending at Planning CE";
							}else if(data[3]=="3"){
								status ="Sent by EE PHM/Pending at Control Center EE";
							}else{
								status ="Sent by EE PHM/Pending at Area Engineer/Control Center EE/Planning CE";
							}
							
						}
						if(data[2]=="96"){
							if(data[3]=="1"){
								status ="Recommended by Area Engineer/Pending at Control Center";
							}else if(data[3]=="2"){
								status ="Recommended by Planning CE/Pending at Control Center";
							}else if(data[3]=="3"){
								status ="Recommended by Control Center EE/Pending at Control Center";
							}else{
								status ="Recommended by EE PHM/Pending at Control Center";
							}
		        ...
		        function selectHandler() {
		         ...
		         if(selectedItem){
 		            ...
 		            $.ajax({
 		   		    ...
 		   		    datavaluepie.addColumn('string', 'Nature of Interruption');
...
<body>
 ...
 -->								
      ...
      <div id="matdetail_divdetail"></div>
