													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
                												...
                												<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/viewLineSummary?id=${province.compId}&dd=${name}&province=${province.compNm}' />" >${province.compNm}</a></td>
        														</tr>
            													</c:forEach> 
