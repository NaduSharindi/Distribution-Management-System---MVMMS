...
<!-- meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"-->
	...
	<script type="text/javascript">
        ...
        function disable(pid)
        {
            ...
            document.getElementById("pcomdate1_"+pid).disabled = false;
            document.getElementById("pcomdate2_"+pid).disabled = false;
       ...
       function save(pid) 
        {
    	   ...
    	   var pcomdate1 = document.getElementById("pcomdate1_"+pid).value;
    	   alert('hiiiii	10' +pcomdate1);
    	   var pcomdate2 = document.getElementById("pcomdate2_"+pid).value;
    	   alert('hiiiii	11' +pcomdate2);
                                              ...
                                              <table class="table table-responsive" id="tblAdmin">
													...
													<tbody>
											           <c:forEach var="support" items="${support}" >
											                <tr>  
											                <td><input type="text" id="pid" value="${support.id}" class="form-control" disabled></td>
											                <td><input type="text" id="pcode_${support.id}" value="${support.towerNo}" class="form-control" disabled></td>
											                 <td><input type="text" id="pname_${support.id}" value="${support.supportType}" class="form-control" disabled></td>
											                 <td><input type="text" id="ptype_${support.id}" value="${support.area}" class="form-control" disabled></td>
											                  <td><input type="text" id="plegnth_${support.id}" value="${support.conductorType}" class="form-control" disabled></td>
											                 <td><input type="text" id="parea_${support.id}" value="${support.towerType}" class="form-control" disabled></td>
											                 <td><input type="text" id="ppoles_${support.id}" value="${support.towerConfiguration}" class="form-control" disabled></td>
											                  <td><input type="text" id="ptowers_${support.id}" value="${support.gpsLatitude}" class="form-control" disabled></td>
											                 <td><input type="text" id="pcomdate_${support.id}" value="${support.gpsLongitude }" class="form-control" disabled></td>
											                 <td><input type="text" id="pcomdate1_${support.id}" value="${support.noOfCircuits }" class="form-control" disabled></td>
											                 <td><input type="text" id="pcomdate2_${support.id}" value="${support.bodyExtension }" class="form-control" disabled></td>
											                ...
											                <td><button type='button' class='btn btn-warning' onClick='LoadProvincesToEdit("${support.id}")'>Edit</button>&nbsp;
											                <button type='button' class='btn btn-success' onClick='javascript:save("${support.id}")'>Save</button></td>      
											                </tr>
