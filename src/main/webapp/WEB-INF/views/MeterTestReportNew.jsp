	...
	<form:form method="post" enctype="multipart/form-data" action="MeterTRSave"	modelAttribute="model">
         ...
         <div class="input-box2">
          ...
          <div class="input-box">
            ...
            <select class ="drop-down">
                 <option value="NMI">New meter Installation- Solar Net Plus</option>
                 <option value="HTB">Harmonic Test - Bulk</option>
                <option value="RTT">Routine</option>
                <option value="NTT">New connection</option>
                 <option value="CTT">Capacity Augment</option>
                <option value="MTT">Meter change</option>
