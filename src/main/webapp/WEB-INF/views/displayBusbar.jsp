	...
	var strCode = cmbSelectGantry.options[cmbSelectGantry.selectedIndex].value;
     ...
     ({
             ...
             success: function(response) 
             {
                 ...
                 for (var i = 0; i < response.length; i++) {
                     var item = response[i];
                     document.getElementById("cmbSelectBusBarCondutor").value = item.busBarCondutoer;
                     document.getElementById("cmbSelectBusBarInsulator").value = item.busBarInsulator;
                     document.getElementById("txtnoOfLBS").value = item.busBarLbs;
                     document.getElementById("txtnoOfTransformers").value = item.busBarNoTranformer;
                     document.getElementById("txtnoOfABS").value = item.busBarAbs;
                     document.getElementById("txtnoOfDDLOSets").value = item.busBarDdlo;
                     document.getElementById("txtnoOfSurgeArrestors").value = item.busBarSa;
			...
			<div class="row">
				...
				<div class="col-lg-12">		                                    
                        <div class="col-lg-9">
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li class="active"><span>Update Bus bar & Auxiliary System</span></li>
                            </ol>
						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									...
									<form:form role="form" action="MMSupdateBusbar" method="post" modelAttribute="UpdateBusbar">
																...
																<form:select path="gantry.province" onchange="findArea()" class="form-control" id="cmbSelectProvince" name="cmbSelectProvince">
																   ...
																   <form:options items="${UpdateBusbar.provinceList}" /> 
																</form:select>
																...
																<form:select path="gantry.area"  onchange="getLine();getGantryByArea();" class="form-control" id="cmbSelectArea" name="cmbSelectArea">
																     <form:options items="${UpdateBusbar.areaList}" />
																</form:select>
																...
																<form:select path="gantry.lineId" onchange="getGantryByAreaLine()" class="form-control" id="cmbSelectLineId" name="cmbSelectLineId">
																      <form:options items="${UpdateBusbar.lineList}" />
																</form:select>
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="gantry.busBarNoTranformer" type="number" value ="0" min="0" class="form-control" id="txtnoOfTransformers" placeholder="Enter No Of Transformers"/>
