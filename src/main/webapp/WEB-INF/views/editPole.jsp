...
function editAll(stringIDs) {
	...
	for (var count = 0; count < len; count++) {
		LoadPolesToEdit(arrayAllIds[count]);
	}
...
function sendForValidation() {
	...
	var url = "/MMS/updatePoleStatusNew/" + area + "/";
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-9">
								<ol class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active"><span>Edit Pole </span></li>
								</ol>
							</div>
								...
								<div class="main-box-body clearfix">
									<div class="table-responsive">
										<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" action="displayPoleNewS"
															...
															<c:forEach var="pole" items="${model.poleListEdit}">
																<tr>
																	...
																	<td><button type='button' class='btn btn-warning'
																			onClick='LoadProvincesToEdit("${pole.id}")'>Edit</button></td>
