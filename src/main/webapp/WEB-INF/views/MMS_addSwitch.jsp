			...
			<div class="row">
				...
				<div class="col-lg-12">		                                    
                        <div class="col-lg-9">
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li class="active"><span>Add Switches</span></li>
                            </ol>
								   ...
								   <c:if test="${SUCCESS_MESSAGE != null}">
									...
									<div class="tab">
											...
											<div id="Auto" class="tabcontent">
  											<h1>Auto Recloser</h1>
  											<form:form role="form" enctype="multipart/form-data" action="MMSaddSwitch" method="post" modelAttribute="SaveSwitch">
									         ...
									         <table class="table table-responsive" id="tblProvinces">
									           <tbody>
																...
																<form:select path="" onchange="findAreaAR()" class="form-control" id="cmbSelectProvinceAR" name="cmbSelectProvinceAR">
																   ...
																   <form:options items="${SaveSwitch.provinceList}" /> 
																</form:select>
																...
																<form:select path=""  onchange="getLineAR();getGantryByAreaAR();" class="form-control" id="cmbSelectAreaAR" name="cmbSelectAreaAR">
																     <form:options items="${SaveSwitch.areaList}" />
																</form:select>
																...
																<form:select path="" onchange="getGantryByAreaLineAR()" class="form-control" id="cmbSelectLineIdAR" name="cmbSelectLineIdAR">
																      <form:options items="${SaveSwitch.lineList}" />
																</form:select>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="switches.id.feederId" class="form-control" id="cmbSelectFeederAR" name="cmbSelectFeederAR">
									                           ...
									                           <tr>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="switches.switchName" type="text" class="form-control" id="txtIDAR" placeholder="Enter Name"/>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="switches.location" class="form-control" id="cmbSelectBrandNameAR" name="cmbSelectBrandNameAR">
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="switches.sgDateCommitioning" type="text" class="form-control" id="txtDateAR1"/>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="switches.sgDateManufature" type="text" class="form-control" id="txtCDateAR1"/>
											...
											<div id="LBS" class="tabcontent">
									         ...
									         <table class="table table-responsive" id="tblProvinces">
									           <tbody>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="switches.id.feederId" class="form-control" id="cmbSelectFeederLBS" name="cmbSelectFeederLBS">
									                           ...
									                           <tr>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="switches.switchName" type="text" class="form-control" id="txtIDLBS" placeholder="Enter Name"/>
																<span id="spnIDLBS" class="label label-danger"></span>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="switches.location" class="form-control" id="cmbSelectBrandNameLBS" name="cmbSelectBrandNameLBS">
										                        <form:option value="1">Gantry</form:option>
													            <form:option value="2">Line</form:option>
													            </form:select>
																<span id="spnBrandNameLBS" class="label label-danger"></span>
										...
										<div class="form-group">
											...
											<div id="ABS" class="tabcontent">
 											<h1>ABS</h1>
  											<form:form role="form" action="MMSaddSwitch" method="post" modelAttribute="SaveSwitch">
									         ...
									         <table class="table table-responsive" id="tblProvinces">
									           <tbody>
															...
															<%-- 	<tr>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="switches.id.feederId" class="form-control" id="cmbSelectFeederABS" name="cmbSelectFeederABS">
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="switches.switchName" type="text" class="form-control" id="txtIDABS" placeholder="Enter Name"/>
																<span id="spnIDABS" class="label label-danger"></span>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="switches.location" class="form-control" id="cmbSelectBrandNameABS" name="cmbSelectBrandNameABS">
										                        <form:option value="1">Gantry</form:option>
													            <form:option value="2">Line</form:option>
													            </form:select>
																<span id="spnBrandNameLBS" class="label label-danger"></span>
											...
											<div id="DDLO" class="tabcontent">
									         ...
									         <table class="table table-responsive" id="tblProvinces">
									           <tbody>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="switches.id.feederId" class="form-control" id="cmbSelectFeederDDLO" name="cmbSelectFeederDDLO">
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="switches.switchName" type="text" class="form-control" id="txtIDDDLO" placeholder="Enter ID"/>
																<span id="spnIDDDLO" class="label label-danger"></span>
