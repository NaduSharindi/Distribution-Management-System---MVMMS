                                    ...
                                    <%-- <tr>
												 ...
												 <td>Tower Line Name</td>
													...
													<tr>
														<td>User ID</td>
														<td><form:input
																path="user.userId" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="User ID" />
															</td>
															</tr>
													...
													<tr>
														<td>User Name</td>
														<td><form:input
																path="user.userNm" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
                                  	...
                                  	<tr>
														...
														<td><form:input
																path="user.rptUser" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
														...
														<td>User Level</td>
														<td><form:input
																path="user.userLevel" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
