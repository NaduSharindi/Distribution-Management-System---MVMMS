...
j( function() {
	...
	function confirmRequest(id){
		...
		//var incharge_es = "TEST";
		var incharge_es = document.getElementById("es_"+id).value;
		if (permit_no === ""){
    ...
    if (td) {
      ...
      if (txtValue.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
													   ...
													   <table id="example" class="table table-striped table-bordered table-sm " style="width:10%">
													   	<thead>
															<c:choose>
														...
														<c:when test="${submitType=='Maintenance'}">
																<tr>
															<th class="th-sm" style = "background-color:DarkGrey">Maintenance Request No</th>
															<th class="th-sm" style = "background-color:DarkGrey">Area</th>
															
															<th class="th-sm" style = "background-color:DarkGrey">Requirement</th>
															<th class="th-sm" style = "background-color:DarkGrey">Requesting section/s to be maintained</th>
														...
														<c:when test="${submitType=='WayLeave'}">
																<tr>
															<th class="th-sm" style = "background-color:DarkGrey">WayLeave Request No</th>
															<th class="th-sm" style = "background-color:DarkGrey">Area</th>
														...
														<c:when test="${submitType=='Interruption'}">
															...
															<!-- <th></th>
															 -->
															<th class="th-sm" style = "background-color:DarkGrey">Interruption Request No</th>
															<th class="th-sm" style = "background-color:DarkGrey">Permit Number</th>
															<th class="th-sm" style = "background-color:DarkGrey">Incharge ES (ECSC)</th>
															
															<th class="th-sm" style = "background-color:DarkGrey">Action</th>
															<th class="th-sm" style = "background-color:DarkGrey"></th>
															<th class="th-sm" style = "background-color:DarkGrey">Reschedule Date</th>
															<th class="th-sm" style = "background-color:DarkGrey">Alternative Supply Arrangement</th>
															
															<th class="th-sm" style = "background-color:DarkGrey">Forwarded Date & Time</th>
														...
														<tbody>
															<c:forEach var="email" items="${model.unReadInspectionReq}">
																...
																<td style="text-align:left"><textarea class="form-control" disabled>${email.referenceNo}</textarea></td>
...
<c:when test="${submitType=='Interruption'}">
																...
																<tr>
																<%--<a href="displayAllInsRequestAEIntNewView?mode=XXX&id=${email.approvalId}">${email.approvalId} <td><button type='button' class='btn btn-info' onclick='loadNetwork("${email.approvalId}")'><i class="fa fa-check"></i></button></td>
																 --%>
																<td>${email.approvalId}</td>
																<td><form:input style="text-align:center" type="text" id="permit_no_${email.approvalId}" path="intRequestObj.permitNo"></form:input></td>
																<td><form:input style="text-align:center" type="text" id="es_${email.approvalId}" path="intRequestObj.permitNo"></form:input></td>
																
																<td> <select id="action_${email.approvalId}"onclick='enableResheduleDate("${email.approvalId}")'  style="background-color: #94cb71;">
																...
																<td><button type='button' class='btn' onclick='actionTaken("${email.approvalId}")' title ='OK'><i class="fa fa-check"></i></button></td>
																							
																<td><input type="date" id="datepicker1_${email.approvalId}"></input></td>
																<td><textarea id="altsup_${email.approvalId}" ></textarea></td>   
																
																<td>${email.forwardDate} ${email.forwardedTime}</td>
				
																<td><button type='button' class='btn1' onclick='loadNetwork("${email.approvalId}")'>Network View</button> 
																<button type='button' class='btn1' onclick="window.location.href='downloadInterruptionReq?id=${email.approvalId}'" >More Info</button></td>
																
																<!--
																<td><button type='button' class='btn btn-info' onclick="window.location.href='downloadInterruptionReq?id=${email.approvalId}'">Generated Letter</button></td>   
