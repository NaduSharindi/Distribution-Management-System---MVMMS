...
<div id="Information2" class="tabcontent">
 ...
 <div class="container">
	    ...
	    <div class="user-details" >   
          <div class="input-box">
            <span  class="details"  >Estimate Number: </span>
             <form:input path="pcesthttModel.estimateNo" />
          </div>
          <div class="input-box">
            <span  class="details"  >Job Number: </span>
             <form:input path="pcesthttModel.projectNo" />
          </div>
          ...
          <div class="input-box">
            <span class="details">Initial Total Cost: </span>
             <form:input path="pcesthttModel.stdCostInitial" />
          </div>
          <div class="input-box">
            <span class="details">Variance : </span>
             <form:input path="pcesthttModel.percentage" />
          </div>
  ...
  <button type="button" class="button button4" onclick='viewPrint("${pcesthttModel.estimateNo}","${pcesthttModel.deptId}")'>View Estimate Print</button>
  </div> --%>
