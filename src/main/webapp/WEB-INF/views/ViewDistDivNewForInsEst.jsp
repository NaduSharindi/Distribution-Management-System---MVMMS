											...
											<div class="col-lg-12">
												<div class="main-box clearfix">
													<header class="main-box-header clearfix">
														<h2 class="pull-left">CEB Provinces</h2>
													</header>
													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
                											...
                											<!-- 	<td style="text-align:left" ><a href="<c:url value='/ViewSummaryForInsEst?id=${dist.compId}&name=${dist.compNm}' />" >${dist.compNm}</a></td>-->
        <td  style="text-align:left"   ><a href="<c:url value='/ViewSummaryForInsEst?id=${dist.compId}&dd=${name}&province=${dist.compNm}' />" >${dist.compNm}</a></td>
