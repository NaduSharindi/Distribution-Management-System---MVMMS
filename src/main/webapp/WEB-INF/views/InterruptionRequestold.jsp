 ...
 <tr>
														...
														<tr>
														 ...
														 <tr>
                											...
                											<td width="70%" style="text-align:left">
	                											<label>
																	<form:input path="dateOfWork" type="date" id="dateofwork" placeholder="Date and Time of Work" class="form-control"/>
                											...
                											<td width="70%" style="text-align:left">
                												<label>
																	<form:input path="timeDuration" type="text" id="dateofwork" placeholder="Time Duration of Work" class="form-control"/>
															...
															<tr>
 																...
 																<td width="70%" style="text-align:left">
  																	<label>
  																		<form:textarea id="txtLocation" path="mailContent" rows="5" cols="60" placeholder="Enter Location" class="form-control"/> 
																			<c:if test="${not empty model.error1}"> 
 																		 		<div> 
  																					<span id="spnLocation" class="label label-danger">${model.error1}</span> 
																				</div> 
																			</c:if> 
  																	</label>
  																</td>
 															...
 															<tr>
																 <td width="30%" style="text-align: left">
																 	<form:label path="">Field of work</form:label>
																 </td>
																 <td width="70%" style="text-align:left">
																	<label>
																		<form:textarea path="mailContent2" rows="5" cols="60" placeholder="Enter Field of work" class="form-control"/>
															...
															<td width="70%" style="text-align: left"><form:select
                												...
                												<td width="40%" style="text-align:left">
																<input  type="file" name="file2" id="file2" onchange="show2()">
																</td>
																<td width="30%" style="text-align:left">
                												...
                												<td width="40%" style="text-align:left">
																<input  type="file" name="file3" id="file3" onchange="show3()">
																</td>
																<td width="30%" style="text-align:left">
                												...
                												<td width="40%" style="text-align:left">
																<input  type="file" name="file4" id="file4" onchange="show4()">
																</td>
																<td width="30%" style="text-align:left">
