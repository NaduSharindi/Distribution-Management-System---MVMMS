...
j( function() {
	...
	function confirmRequest(id){
		...
		$.ajax({
				...
				contentType : "application/json; charset=utf-8",
				success : function(data) {
					alert("Succesfully confirmed...Email-SMS is succesfully sent to PHM-DD2 ");
					window.location.reload();
...
function notConfirmRequest(id){
		...
		$.ajax({
			...
			contentType : "application/json; charset=utf-8",
			success : function(data) {
				alert("Succesfully done...Email-SMS is succesfully sent to PHM-DD2 ");
				window.location.reload();
...
<c:when test="${submitType=='Interruption'}">
										                        ...
										                        <input style="text-align:center" type="text" id="" value="${email.approvalId}"  class="form-control"></td>
																...
																<td style="text-align:left"><textarea rows="3" cols="20" id="altsup_${email.approvalId}" ></textarea></td>
