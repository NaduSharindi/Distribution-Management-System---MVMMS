					...
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-9">
								<ol class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active"><span>PHM Branch Schedule </span></li>
								</ol>
							</div>
												...
												<form:form method="post" action="GenerateHotLineReport"
													...
													<table class="table table-responsive" id="tblProvinces">
														...
														<tr>
															...
															<td width="70%" style="text-align: left"><form:select
																	id="method" path="mode" onchange="">

																	<form:option value="201901" label="LATEST INSPECTION " />
																	<form:option value="" label="LAST AVARAGE " />
																</form:select></td>
														</tr>
													<!-- 	<tr>
															<td width="30%" style="text-align: left"><form:label
