...
//                var t = document.getElementById( "t11_" + pid ).value;
            ...
            function sendForValidation()
            {
                ...
                var url = "/MMS/updateSupportStatus/" + province + "/" + area + "/" + line;
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table class="table table-responsive" id="tblProvinces">
                                                ...
                                                <tbody>
                                                    <form:form method="post" action="viewSupportNewS" modelAttribute="model">
                                                        ...
                                                        <table class="table table-responsive" id="tblProvinces">
                                                            ...
                                                            <tr>
                                                                <td width="30%" style="text-align:left">PROVINCE
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td width="30%" style="text-align:left">LINE
                                                                </td>
                                                                <td width="70%" style="text-align:left">
...
<%-- <td><img id="t12_${Support.id}" src='data:image/jpg;base64, ${Support.base64Image}' alt="${Support.filepath}" height="40" width="40"/></td>
 --%>
                                                                       ...
                                                                       <%--  <td><select id="a1_${Support.id}" class="form-control"
                                                                                ...
                                                                                <c:choose>
                                                                                    <c:when test="${Support.supportType==1}">
                                                                                        ...
                                                                                        <option value="4">GSS
                                                                                            Bay</option>
                                                                                            <option value="5">Line Gantry</option>
                                                                                    </c:when>
                                                                                    ...
                                                                                    <c:when test="${Support.supportType==3}">
                                                                                        ...
                                                                                        <option value="4">GSS
                                                                                          ...
                                                                                          <c:when test="${Support.supportType==5}">
                                                                                        <option value="${Support.supportType}"
                                                                                            selected="selected">Line Gantry</option>
                                                                                        <option value="1">Tower</option>
                                                                                        <option value="2">Pole</option>
                                                                                        <option value="4">GSS
                                                                                            Bay</option>
