						...
						<ul class="submenu">
							<li>
								...
								<ul class="submenu">
									...
									<li>
										<a href="viewTTWTapping?mode=TTWT">
										Tension Tower Without Tapping
										</a>
									</li>
									<li>
										<a href="viewColdLine?mode=CLE">
										Cold Line Electrical
										</a>
									</li>
									<li>
										<a href="viewColdLineCivil?mode=CLC">
										Cold Line Civil
										</a>
									</li>
									<li>
									...
									<ul class="submenu">
									<li>
										<a href="viewElectricalWorksOnPoles?mode=EWOP">
										Electrical Works On Poles
										</a>
									</li>
									<li>
										<a href="viewVegitationSchedule?mode=VR">
										Vegetation Schedule
										</a>
									</li>
									<li>
										<a href="viewMissingPartsSchedule?mode=MP">
