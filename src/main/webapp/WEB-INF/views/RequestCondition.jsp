...
function getImage(id,conceptCycleValue){
        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="item-1-1-tab" data-toggle="tab" role="tab" aria-controls="item-1-1" aria-selected="true" href="#item-1-1" >Details&gt;</a></li>
                  <!--    <li class="nav-item"><a class="nav-link" id="item-1-2-tab" data-toggle="tab" role="tab" aria-controls="item-1-2" aria-selected="false" href="#item-1-2">Attachment&gt;</a></li>
                        ...
                        <div class="table-responsive" style="padding: 47px;">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr></tr>
                                    <tr>
                                        <td style="font-size: 24px; color: #BC576F;">Request Information<br></td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <%-- <tr>
												 ...
												 <td>Tower Line Name</td>
													...
													<tr>
														...
														<td><form:input
																path="approvalMmObj.approvalId" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
                                  	...
                                  	<tr>
														<td>Area</td>
														<td><form:textarea
																path="approvalMmObj.referenceNo" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Area" ></form:textarea>
															</td>
															</tr>
														<tr>
														<td>Tower No From - To</td>
														<td><form:textarea
																path="approvalMmObj.fromto" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Tower No From - To" ></form:textarea>
															</td>
															</tr>
													...
													<tr>
														<td>Time Duration</td>
														<td><form:input
																path="approvalMmObj.timeduration" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Time Duration"  /> 
													</tr>
													<tr>	
														<td>Requested EE/ES</td>
														<td><form:textarea
																path="approvalMmObj.reason" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Requested EE/ES"  ></form:textarea> </td>
													
													</tr>
													<tr>
														<td>Request Created Date</td>
													<td><form:input
																path="approvalMmObj.approvedDate" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
														...
														<tr>
														<td>Request Created Time</td>
													<td><form:input
																path="approvalMmObj.approvedTime" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Request Created Time"  /> 
													</td>
													...
													<td><form:input
																path="approvalMmObj.forwardDate" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Forwarded Date"  /> 
													</td>
															
														</tr>
														<tr>
														<td>Forwarded Time</td>
													<td><form:input
																path="approvalMmObj.forwardedTime" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Forwarded Time"  /> 
													</td>
															
														</tr>
														<%-- <tr>
														<c:if test="${approvalMmObj.filename1 != null}">
  																	<td><button type='button' class='button button2' onclick="window.location.href='downloadIntImgReq?id=${approvalMmObj.filename1}&seq=1'">Image 1</button></td>
																</c:if>
																<c:if test="${approvalMmObj.filename2 != null}">
  																	<td><button type='button' class='button button2' onclick="window.location.href='downloadIntImgReq?id=${approvalMmObj.filename2}&seq=1'">Image 2</button></td>
																</c:if>
																<c:if test="${approvalMmObj.filename3 != null}">
  																	<td><button type='button' class='button button2' onclick="window.location.href='downloadIntImgReq?id=${approvalMmObj.filename3}&seq=1'">Image 3</button></td>
																</c:if>
																<c:if test="${approvalMmObj.filename4 != null}">
  																	<td><button type='button' class='button button2' onclick="window.location.href='downloadIntImgReq?id=${approvalMmObj.filename4}&seq=1'">Image 4</button></td>
																</c:if>
																<c:if test="${approvalMmObj.filename5 != null}">
  																	<td><button type='button' class='button button2' onclick="window.location.href='downloadIntImgReq?id=${approvalMmObj.filename5}&seq=1'">Image 5</button></td>
																</c:if>
         ...
         <div id="item-1-2" class="tab-pane fade" role="tabpanel" aria-labelledby="item-1-2-tab">
                ...
                <div class="table-responsive" style="padding: 47px;">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="font-size: 24px;color: rgb(188,87,111);">Tower Image</td>
                                        
                                    </tr>
                                    <tr>
														<td>Tower Image</td>
														<td><c:if test="${mnt.flashoversetno != null}">
  														  <button type ='button' class='btn' title='View Image' onClick='getImage("${mnt.id.towerid}","${mnt.id.towerid}")'>View</button>
														  </c:if>
	</td>
	</tr>
