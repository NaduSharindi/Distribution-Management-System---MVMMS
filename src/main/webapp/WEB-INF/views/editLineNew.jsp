...
<script type="text/javascript">
	...
	function disable(pid) {
		...
		document.getElementById("pfeeiden_" + pid).disabled = true;
	...
	function enable(pid) {
		...
		document.getElementById("pfeeiden_" + pid).disabled = false;
	...
	function save(pid) {
		...
		var feeder = document.getElementById("pfeeiden_" + pid).value;
													...
													<div id="table-scroll" class="table-scroll"> 
														...
														<tbody>
															<c:forEach var="line" items="${model.lineListEdit}">
																<tr>
																	<th><input type="text" id="pcode_${line.id}"
																		value="${line.code}" class="form-control" disabled></th>
