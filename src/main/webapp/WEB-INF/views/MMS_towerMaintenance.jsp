						...
						<div class="col-lg-12">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									...
									<form:form method="post" role="form" modelAttribute="SaveTowermaintenanceData" action="MMStowerMaintenanceAddTm" onsubmit="return enable()" id="reg">
										 ...
										 <table class="table table-responsive" id="tblProvinces">
										  <tbody>
																...
																<form:select path="" name="cmbCycle" id="cmbCycle">
													<form:option value="" selected="selected"> << SELECT >> </form:option>
													<form:option value="201801"> 201801 </form:option>
													<form:option value="201802"> 201802 </form:option>
													<form:option value="201901"> 201901 </form:option>
													<form:option value="201902"> 201902 </form:option>
													<form:option value="202001"> 202001 </form:option>
													<form:option value="202002"> 202002 </form:option>
												
							
												</form:select>
												<span id="spnCycle class="label label-danger"></span>
																</td>
