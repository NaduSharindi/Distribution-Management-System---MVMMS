...
<tr>
    ...
    <c:forEach var="email" items="${model.unReadInspectionReq}">
						...
						<tr>
																...
																<td><button type='button' class='btn btn-success' onClick='openPopupSubmit("${email.approvalId}")'><i class="glyphicon glyphicon-folder-open"></i></button></td>
																<td><button type='button' class='btn btn-success' onClick='openPopupRec("${email.approvalId}")'><i class="glyphicon glyphicon-folder-open"></i></button></td>
																<c:if test="${email.filename1 != null}">
