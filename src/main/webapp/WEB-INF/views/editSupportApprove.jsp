          ...
          //edit anushka 2019-01-02------------------------------------------------------------------------------------------------------------------------
        	function saveAll() {
        		...
        		for (var count = 0; count < len; count++) {
        			...
        			var t = document.getElementById("t30_" + pid).value;
...
//alert(url);
		...
		for (var count = 0; count < len; count++) {
            ...
            function disable( pid )
            {
                ...
                document.getElementById( "t30_" + pid ).disabled = true;
...
//                document.getElementById( "t11_" + pid ).disabled = false;
                ...
                document.getElementById( "t30_" + pid ).disabled = false;
...
var t = document.getElementById("t30_" + pid).value;
               ...
               // alert( "sType: " + a + " / id: " + pid + " / area: " + d + " / csc: " + e + " / cType: " + f + " / ecType: " + g + " / tType: " + h + " / tConfig: " + i + " / gpsLat: " + j + " / gpsLon: " + k + " / nofCir: " + l + " / bExten: " + m + " / tapping: " + t + " / mapId: " + x + " / status: " + status + " / appLevel: " + n );
                ...
                //var url = "/MMS/updateSupport/" + a + "/" + pid + "/" + d + "/" + e + "/" + f + "/" + g + "/" + h + "/" + i + "/" + j + "/" + k + "/" + l + "/" + m + "/" + "0" + "/" +x +"/" +status + "/" + n;
                /* var url = "/MMS/updateSupportNew/" + c + "/"  + a + "/" + pid + "/" + d 
                + "/" + e + "/" + f + "/" + g + "/" + h + "/" + i + "/" + j + "/" + k + 
                "/" + l + "/" + m + "/" + t + "/" +x +"/" +status + "/" + n + "/" + resArea + "/" + fromSec + "/" + toSec;
                 */
            ...
            function sendForValidation()
            {
                ...
                var url = "/MMS/updateSupportStatusApprove/" + province + "/" + area + "/" + line;
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-9">
                                    <ol class="breadcrumb">
                                        <li><a href="#">Home</a></li>
                                        <li class="active"><span>Approved Supports </span></li>
                                    </ol>
                                </div>
...
<table class="table table-striped table-bordered table-sm " >
                                                ...
                                                <tbody>
                                                    <form:form method="post" action="displaySupportApproveS" modelAttribute="model">
                                                        ...
                                                        <table class="table table-responsive" id="tblProvinces">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="70%" style="text-align:left">
                                                                    ...
                                                                    <form:select id="area" path="gldeptobj.deptId"
                                                                        onchange="getLine()" style="width:50%; background-color: #FFFFF; border-radius: 5px;">
                                                                        <form:option value="NONE" label="ALL" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="70%" style="text-align:left">
                                                                    <form:select id="line" path="line.code" onchange="" style="width:50%; background-color: #FFFFF; border-radius: 5px;">
...
<table class="table table-striped table-bordered table-sm " >
                                                               ...
                                                               <!--  <th></th>
                                                                -->     <th class="text-center">Tower No</th>
                                                                    ...
                                                                    <th class="text-center">Approval Level</th>
                                                                     <th class="text-center">Responsible Area</th>
                                                                    <th class="text-center">Section -From</th>
                                                                    <th class="text-center">Section -To</th>
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="Support" items="${model.support}">
                                                                    <tr>
                                                                    <%-- <th>  <input type="file" id="myFile" name="filename"><button type='button' class='btn btn-info' onclick='javascript:upload("${Support.id}")' title ='OK'><i class="fa fa-check"></i></button></th>
  --%><th><input type="text" id="c3_${Support.id}"
                                                                        ...
                                                                        <td><input type="text" id="t12_${Support.id}"
                                                                                ...
                                                                                <td><input type="number" id="t30_${Support.id}"
                                                                        ...
                                                                        class="form-control" disabled>
                                                                            ...
                                                                            <c:forEach var="supType"
                                                                                items="${model.sTypeList}">

                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${supType.id != Support.supportType}">
                                                                                ...
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        ...
                                                                                        <option value="${supType.id}"
                                                                                            selected="selected">${supType.supportType}</option>
                                                                                    </c:when>
                                                                                </c:choose>
                                                                            </c:forEach>
                                                                    </select></td>  
 ...
 --%>
                                                                        ...
                                                                        class="form-control" disabled>
                                                                            ...
                                                                            <c:forEach var="conType"
                                                                                items="${model.conTypeList}">
                                                                            ...
                                                                            <c:forEach var="conType"
                                                                                ...
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${conType.id == Support.conductorType}">
                                                                                        <option value="${conType.id}"
                                                                                            selected="selected">${conType.type}</option>
                                                                                    </c:when>
                                                                                </c:choose>
                                                                            </c:forEach>
                                                                    </select></td> 
                                                                        ...
                                                                        class="form-control" disabled>
                                                                            ...
                                                                            <c:forEach var="towerType"
                                                                                items="${model.towerType}">

                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${towerType.id != Support.towerType}">
                                                                      ...
                                                                      <td><select id="m13_${Support.id}"
                                                                        ...
                                                                        <td><select id="pstatus_${Support.id}" class="form-control"
                                                                                ...
                                                                                <c:choose>
                                                                                    ...
                                                                                    <c:when test="${sessionScope.loggedUserRole=='EE'}">
                                                                                    		<option value="${Support.status}" selected="selected">Approve</option>
                                                                        ...
                                                                        <td><input type="text" id="res_${Support.id}" value="${Support.responsibleArea}"
                                                                                class="form-control" disabled></td>
                                                                        <td><input type="text" id="fromsection_${Support.id}" value="${Support.sectionId}"
                                                                                class="form-control" disabled></td>
                                                                         <td><input type="text" id="tosection_${Support.id}" value="${Support.sectionIdTo}"
                                                                                class="form-control" disabled></td>
														...
														<td>
															<button type='button' class='btn btn-warning'
																onClick='javascript:editAll("${model.stringOfSupportIds}")'>Edit All</button>
														</td>
