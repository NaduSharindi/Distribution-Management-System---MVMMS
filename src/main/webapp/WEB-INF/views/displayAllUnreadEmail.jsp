													...
													<table class="main-table" id="tblAdmin">
														...
														<tbody>
															<c:forEach var="email" items="${model.unReadEmailList}">
																<tr>
																	<th class="text-center"><input style="text-align:center;"  type="text" id="pid" value="${email.approvalId}"
																		class="form-control" disabled></th>
																	<td class="text-center"><input style="text-align:center;" type="text" id="pname_${email.approvalId}"
																		value="${email.reason}" class="form-control" disabled></td>
																	
																	<td class="text-center"><input style="text-align:center;" type="text" id="pcode_${email.approvalId}"
