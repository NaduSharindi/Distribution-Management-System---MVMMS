					...
					costcenterForList = value;
    		          ...
    		          //  var value = datavaluepie.getValue(selectedItem.row, 2);
    		           // alert('The user selected ' + value);
    		            ...
    		            $.ajax({
    		    			type : 'GET',
    		    			url : "/MMS/getApprovalListByCostCenterAE/" +value+"/" ,
    		    			data : {},
    		    			contentType : "application/json; charset=utf-8",
    		    			success : function(result) {
							...
							<div class="col-lg-12">
								...
								<div class="wrimagecard-topimage_header"
												style="background-color: #a1d0d0; border-radius: 5px;">
															...
															<strong>Please select the ceb branch</strong>
 ...
 -->					
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="wrimagecard-topimage_header"
												style="background-color: #a1d0d0; border-radius: 5px;">
												<strong>Please select the Estimate Number</strong>
																									<div id="dashboard_div">
      <!--Divs that will hold each control and chart-->
...
<input type="submit" id ="btnViewPrint" Value="View Estimate Print Out" class="btn btn-success" onClick="viewPrint()" />
 ...
 -->    <input type="hidden" id ="txtEstNo" style="background-color:#FCA2A8;" Value="Estimate Number to be Approved" class="form-control" disabled/>
 <input type="text" id ="txtReason" Value="Reject Reason" class="form-control"/>
...
<input type="hidden" id ="txtCostCenter" Value="Estimate No to be Approved" class="form-control" disabled/>
  ...
  <button type="button" id ="btnPrint" class="btn btn-secondary" onClick="viewPrint()">View Print Out</button>
</div>
</div>
