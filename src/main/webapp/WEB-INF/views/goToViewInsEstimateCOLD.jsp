					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="col-lg-9">
								<ol class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active"><span>COLD LINE ESTIMATE</span></li>
								</ol>
							</div>
								...
								<div class="main-box-body clearfix">
									<div class="table-responsive">
										<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" action="goToViewInsEstimateSCOLD"
									...
									<div class="msgSuccess">
										<c:out value="${model.mode}"></c:out>
													...
													<table class="table table-striped table-bordered table-sm " id="tblProvinces">
														...
														<tr>
															<td width="20%" style="text-align: left" class="gtext">Province</td>
														...
														<tr>
															...
															<td width="80%" style="text-align: left"><form:select
																	id="area" path="gldeptobj.deptId" onchange="getLine()" class="form-control">
																	<form:option value="NONE" label="ALL" />
														...
														<tr>
															<td width="20%" style="text-align: left">Electrical
																	Superintendent</td>
															<td width="80%" style="text-align: left"><form:select
																	id="userId" path="sauserm.userId" onchange="" class="form-control">
														...
														<tr>
															<td width="20%" style="text-align: left">Applicant</td>
															<td width="80%" style="text-align: left"><form:select
																	id="userId" path="applicant.idNo" onchange="" class="form-control">
																	<form:option value="NONE" label="ALL" />
														...
														<td width="20%" style="text-align: left">Cycle</td>
															<td width="80%" style="text-align: left"><form:select
																	id="cycle" path="cycleObj.id.cycleId" onchange="" class="form-control">
													...
													<c:if test="${canGO =='3'}">
														...
														<br>
														 --><table class="table table-striped table-bordered table-sm " id="tblAdmin">
															...
															<tr>
															<td>
															COLD LINE ESTIMATE for   ${model.cycle}
															</td>
															</tr>
																<tr>
																...
																<tr>
																	<td width="40%" style="text-align: left">Material
																		Cost -C0140</td>
																	<td width="60%" style="text-align: left"><form:input
																			path="inspection.matC0140"
																			value="${inspection.matC0140}" readonly="true"></form:input>
																...
																<tr>
																	<td width="40%" style="text-align: left">Material
																		Cost -W1246</td>
																	<td width="60%" style="text-align: left"><form:input
																			path="inspection.matW1246"
																			value="${inspection.matW1246}" readonly="true"></form:input>
