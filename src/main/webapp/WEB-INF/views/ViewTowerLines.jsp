		...
		<div id="theme-wrapper">
			...
			<form:hidden path="mode" />
														<c:set var="myVar" value="${model.mode}" />
																...
																<form:select  path ="mmsConTypePE.id" id = "conType" onchange="" style="width:50%; background-color: #FFFFF; border-radius: 5px;">
																<form:option value="NONE" label="ALL" />
																...
																<form:select  path ="circuteType" id ="cirType" onchange="" style="width:50%; background-color: #FFFFF; border-radius: 5px;">
																<form:option value="NONE" label="ALL" />
