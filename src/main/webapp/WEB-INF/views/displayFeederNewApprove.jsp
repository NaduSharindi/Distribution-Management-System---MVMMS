...
//alert(strGantry);
	   ...
	   $.ajax
         ({
                 type: 'GET',
                 url: "/MMS/findFeederApproval/"+strGantry+"/",
                 data: {},
                 contentType: "application/json; charset=utf-8",
                 success: function(response) 
                 {   
...
*/
                 ...
                 for (var i = 0; i < response.length; i++) {
                     var item = response[i];
                     document.getElementById("cmbType").value = item.typeInOut;
                     document.getElementById("txtBayNumber").value = item.code;
                     document.getElementById("txtDescription").value = item.name;
                     document.getElementById("cmbFeederType").value = item.feederType;
                     document.getElementById("cmbSelectConductorType").value = item.conductor;
                     document.getElementById("txtnoOfAutoRecloserF").value = item.noAr;
                     document.getElementById("txtnoOfLBSF").value = item.noLbs;
                     document.getElementById("txtnoOfABSF").value = item.noAbs;
                     document.getElementById("txtnoOfSurgeArrestorsF").value = item.noSa;
			...
			<div class="row">
				...
				<div class="col-lg-12">		                                    
                        <div class="col-lg-9">
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li class="active"><span>Update Feeder</span></li>
                            </ol>
						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									...
									<form:form role="form" action="MMSupdateFeederApprove" method="post" modelAttribute="UpdateFeeder">
																...
																<form:select path="" onchange="findArea()" class="form-control" id="cmbSelectProvince" name="cmbSelectProvince">
																   ...
																   <form:options items="${UpdateFeeder.provinceList}" /> 
																</form:select>
																...
																<form:select path=""  onchange="getLine();getGantryByArea();" class="form-control" id="cmbSelectArea" name="cmbSelectArea">
																     <form:options items="${UpdateFeeder.areaList}" />
																</form:select>
																...
																<form:select path="" onchange="getGantryByAreaLine()" class="form-control" id="cmbSelectLineId" name="cmbSelectLineId">
																      <form:options items="${UpdateFeeder.lineList}" />
																</form:select>
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="feeder.id.gantryId" onchange="getFeederByGantryId()" class="form-control" id="cmbSelectGantry" name="cmbSelectGantry">
                												...
                												<td width="70%" style="text-align:left">
																<form:select path="feeder.id.feederId" onchange="loaddata()" class="form-control" id="cmbSelectFeeder" name="cmbSelectFeeder">
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="feeder.gpsLatitude" type="text" value ="0" min="0" step="0.0000001" class="form-control" id="txtGPSLatitude" placeholder="Enter GPS Latitude"/>
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="feeder.gpsLongitude" type="text" value ="0" min="0" step="0.0000001" class="form-control" id="txtGPSLongitude" placeholder="Enter GPS Longitude"/>
                												...
                												<td width="70%" style="text-align:left"><form:select path="feeder.status" id="status" class="form-control">
