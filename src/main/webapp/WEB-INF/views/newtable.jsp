    ...
    <table id= "myTable" class="display table" width="100%">
        ...
        <c:set var="count" value="0" scope="page" />
															...
															<c:forEach var="pcbModel" items="${SaveSample.listPcbModel}"  varStatus="status">
																...
																<tr>
																<td>${status.count}</td>
																<td>${pcbModel.pcbEquipment.referenceNo}</td>
          														<td>${pcbModel.pcbEquipment.branch}</td>
																<td>${pcbModel.pcbLocation.locationDescription}</td>
																<td>${pcbModel.pcbEquipment.sinNo}</td>
									<td><button id = "saveBtn_${pcbModel.pcbEquipment.referenceNo}"  type="button" class="button button2" title='View' onClick='viewPrint("pcbModel.pcbEquipment.referenceNo")'>View</button></td> 
