...
function viewMoreInfo(id){
 	 var url="getRequestDetail?id="+id;
	    var width = 1100;
	    var height = 700;
																...
																<td>
																 ...
																 <!--  <input style="text-align:left" type="text" id="" value="Removed" class="form-control" disabled>
																  --> </c:when>
																   ...
																   <td><button type='button' class='button button2' title ="Request Letter" onClick='openPopupSubmit("${email.approvalId}")'><i class="fa fa-envelope"></i></button></td>
																<td><button type='button' class='button button2' title ="Recommendation Letter" onClick='openPopupRec("${email.approvalId}")'><i class="fa fa-thumbs-up	"></i></button></td>
																<td><button type='button' class='button button2' title ="Request Information" onClick='viewMoreInfo("${email.approvalId}")'><i class="fa fa-info-circle"></i></button></td>
