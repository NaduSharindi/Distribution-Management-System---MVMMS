 ...
 */								
								...
								var f1;
								if(!data[3].feederIdentification){
									f1 = '';
								}else{
									f1 = data[3].feederIdentification;
								}
								...
								var insDetailTable ="<div style='float:right; padding: 10px;'><table id ='ss'><tr><td><button type='button' id='myBtn' onClick='viewEstimate(\"" + data[0].id + "\",\"" + data[0].area + "\")'>Maintenance Details</button></td></tr> "+ 
								"<tr><th>General Info</th></tr><tr><td>Line Name : </td><td>"+
								data[3].lineName+"</td></tr><tr><td>Tower Number :  </td><td>"+
								data[0].towerNo+"</td></tr><tr><td>Grid :</td><td>"+
								gss+"</td></tr><tr><td>Feeder Identification 1 :</td><td>"+
								f1+"</td></tr><tr><td>Feeder Identification 2  </td><td>"+
								f2+"</td></tr><tr><td>Line Type: </td><td>"+
								
								lineType+"</td></tr><tr><td>Line Length(Km) : </td><td>"+
								
								data[3].length+"</td></tr><tr><td>No. of Towers : </td><td>"+
								
								data[3].nooftowers+"</td></tr><tr><td>No. of Poles : </td><td>"+
								
								data[3].noofpoles+"</td></tr><tr><td>GPS Latitude : </td><td>"+
								
								data[0].gpsLatitude+"</td></tr><tr><td>GPS Longitude : </td><td>"+
								
								data[0].gpsLongitude+"</td></tr><tr><td>Distance to Next Tower(m) : </td><td>"+
								
								calcDistance()+"</td></tr> <tr><td>Area : </td><td>"+
								
								data[5]+"</td></tr> <tr><td>Cummulative Length up to the tower(m) : </td><td>"+
								
								calcTotalDistance()+"</td></tr>	<th>Technical Detail</th></tr>"+
								 ...
								 */"<tr><th></th> </tr><tr><th>Maintenance Detail</th></tr>"+ 
								/* "<tr><td>Last Maintenance Date :  </td><td></td></tr>"+
								 */ /* "<tr><td><button type='button' id='myBtn' data-toggle=modal data-target=#myModal onClick='viewEstimate(\"" + data[0].id + "\",\"" + data[0].area + "\")'>View</button></td></tr> "+ 
								 *//* "<tr><td>Hot line maintenance details (ES validated maintenance work summary) :  </td><td></td></tr>"+
								"<tr><td>Cold line maintence details  (ES validated maintenance work summary) :  </td><td></td></tr>"+
								 */
...
/* 		$.ajax({
	...
	function view(id,area){
		...
		$.ajax({
					type : 'GET',
					url : "/MMS/getLatestMaintenanceNew?towerid=" + id +"&area="+area,
					data : {},
					contentType : "application/json; charset=utf-8",
					success : function(data) {
				...
				<div id="content-wrapper">
					...
					<link rel="stylesheet"
						...
						crossorigin="anonymous">
										...
										<c:if
													test="${sessionScope.loggedUserRole =='AGM' || sessionScope.loggedUserRole =='DGM'}">
                            ...
                            <div class="col-lg-12">                                                                                                   
										...
										<c:if
													test="${sessionScope.loggedUserRole =='EE' || sessionScope.loggedUserRole =='CE'}">
												...
												<div style="height: 220px">
													...
													<tr>
														...
														<div class="dropdown " style="width: 100%; height: 50px;">
															...
															<a href="goToInsMntRequest?mode=PHM">Create</a> 
															
																<a href="breakDownMNT?mode=INS">Forward</a> 
																<a href="viewAllInspectionMntRequest?mode=INS">View Status</a> 
																</c:if>
																<c:if test="${sessionScope.loggedUserRole =='ES'}">
									...
									View Status
													...
													<tr>
														...
														<div class="dropdown " style="width: 100%; height: 50px;">
															...
															<a href="goToInsMntRequest?mode=PMT">Create</a> 
															
																<a href="breakDownMNT?mode=MNT">Forward</a> 
																<a href="viewAllInspectionMntRequest?mode=MNT">View Maintenance Request Status</a> 
															</c:if>
															<c:if test="${sessionScope.loggedUserRole =='ES'}">
															
															<a href="breakDownMNT?mode=MNT">Create Breakdown Estimate
								</a>
									...
									View Status
													...
													<div class="dropdown " style="width: 100%; height: 50px;">
															...
															<c:if test="${sessionScope.loggedUserRole =='EE'}">
																...
																<a href="displayAllINSReq?mode=INT">Forward</a> 
																<a href="viewAllInspectionMntRequest?mode=INT">View Status</a> 
										...
										<div class="wrimagecard wrimagecard-topimage">
											<div class="wrimagecard-topimage_header"
												...
												<h4>
													...
													<tr>
													<div class="dropdown" style="width: 100%; height: 50px;">
															<button class="dropbtn"><a href="downloadAPK">Download APK</a></button>
