...
j( function() {
	...
	function saveAll(stringIDs) {
		...
		for (var count = 0; count < len; count++) {
			...
			var url = "/MMS/updateIntteruption?id="+pid+"&csc=" +csc+ "&grid="+grid+"&altsup="+altsup+"&remarks="+remarks+"&announcement="+action+"&incharge="+incharge+"&cycle="+cycle;
 ...
 var cycle = document.getElementById("cycle").value;
		...
		for (var count = 0; count < len; count++) {
			...
			var url = "/MMS/sendForIntteruption?id="+pid+"&csc=" +csc+ "&grid="+grid+"&altsup="+altsup+"&remarks="+remarks+"&announcement="+action+"&incharge="+incharge+"&cycle="+cycle;
									...
									<div class="table-scroll">
									 -->
										<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" action="createIntScheduleAll?mode=${province}&type=${type}"
