...
<script type="text/javascript">
	...
	function sendReport(){
		...
		.ajax({
			type : 'GET',
			url : "/MMS/sendIntReqSumReportPhm?area=" + selectedValues + "&from="+from+"&to="+to,
			data : {},
			contentType : "application/json; charset=utf-8",
			success : function(data) {
...
<body>
								...
								<div class="main-box-body clearfix">
									<div class="table-responsive">
										<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" action="intSumReportsCCS"
 ...
 --%>														<tr>
															...
															<td width="80%" style="text-align: left"><form:select
																	id="area" multiple="true" path="from" onchange=""
																	style="width:50%; height: 80px;  background-color: #FFFFFF; border-radius: 5px;">
																	<form:options items="${model.areaList}" />
																</form:select></td>
														 ...
														 <tr>
															<td width="30%" style="text-align: left">From Date</td>
														...
														<tr>
															<td width="30%" style="text-align: left">To Date</td>
															<td width="70%" style="text-align: left"><form:input
