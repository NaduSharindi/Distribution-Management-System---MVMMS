 ...
 -->
								<div class="main-box-body clearfix">
									...
									<div class="table-scroll">
										<table class="table-responsive" id="tblProvinces">
											<thead>
...
<c:when test="${submitType=='Interruption'}">
																...
																<td><div class="btn-group"><button type='button' onClick='openPopupSubmit("${email.approvalId}")'>Request Letter</button>
																<button type='button' onClick='openPopupRec("${email.approvalId}")'>Recommendation Letter</button>
																<c:if test="${email.filename1 != null}">
  																<button type='button' onclick="window.location.href='downloadIntImgReq?id=${email.filename1}&seq=1'">Image 1</button>
																</c:if>
																<c:if test="${email.filename2 != null}">
  																<button type='button' onclick="window.location.href='downloadIntImgReq?id=${email.filename1}&seq=1'">Image 2</button>
																</c:if>
																<c:if test="${email.filename3 != null}">
  																<button type='button' onclick="window.location.href='downloadIntImgReq?id=${email.filename1}&seq=1'">Image 3</button>
																</c:if>
																<c:if test="${email.filename4 != null}">
  																<button type='button' onclick="window.location.href='downloadIntImgReq?id=${email.filename1}&seq=1'">Image 4</button>
																</c:if>
																<c:if test="${email.filename5 != null}">
  																<button type='button' onclick="window.location.href='downloadIntImgReq?id=${email.filename1}&seq=1'">Image 5</button>
																</c:if>
</tr>
</c:when>
