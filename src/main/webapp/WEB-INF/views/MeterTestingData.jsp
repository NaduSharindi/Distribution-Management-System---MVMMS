...
<body>
				...
				<div id="content-wrapper">
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-9">
							<ol class="breadcrumb">
									<li><a href="#">Data Related To Meter Testing</a></li>
  ...
  <button class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">Data related to meter </button>
  <button class="tablinks" onclick="openCity(event, 'Paris')">New meter details</button>
...
<div class="container">
  <div class="title">Data related to meter - testing</div>
    <div class="content">
      <form action="#">
        <div class="user-details">
          <div class="input-box">
            ...
            <select class ="drop-down">
                ...
                <option value="BBB">Energy Purchase</option>
                 <option value="CCC">Meter Lab</option>
                    <option value="DDD">Area</option>
            </select>
          </div>
          <div class="input-box">
          <span class="details">Report Number</span>
            <input type="number" placeholder="Enter report number" required>
          </div>
          <div class="input-box">
            ...
            <select class ="drop-down">
                ...
                <option value="BBB">HS</option>
                 <option value="CCC">LT Bulk</option>
                    <option value="DDD">3 ph 30A</option>
                <option value="EEE">3 ph 60 A</option>
                <option value="FFF">1 ph</option>
            </select>             
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            <span class="details">Testing Basic</span>
            <select class ="drop-down">
                <option value="volvo">Routine</option>
                <option value="saab">New connection</option>
                 <option value="opel">Capacity Augment</option>
                    <option value="audi">Meter change</option>
                <option value="audi">AEE Request</option>
...
<div id="Paris" class="tabcontent">
     ...
     <div class="container">
    <div class="title">New Meter details</div>
    <div class="content">
      <form action="#">
          <div class="user-details" >   
          <div class="input-box">
