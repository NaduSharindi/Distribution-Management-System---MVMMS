...
<body onload="myMap(new google.maps.LatLng(7.475214, 80.744077), 7);">
 ...
 --> 					
								...
								<div class="main-box-body clearfix">
									<!-- <div class="table-responsive">
									 -->	<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" action="MeterTestingRequestEditS"	modelAttribute="model">
					...
					<tr>
															<td width="20%" style="text-align: left">Order Card Number</td>
															<td width="80%" style="text-align: left"><form:select id="ordercard" path="meter.approvalId"
					...
					<form:form method="post" enctype="multipart/form-data" action="MeterRequestEdtS"	modelAttribute="model">
													<form:hidden path="mode" />
					...
					<c:if test="${not empty model.error}">
					 ...
					 <tr>
															<td width="20%" style="text-align: left">Order Card Number</td>
															<td width="70%" style="text-align: left"><form:input path="meter.approvalId" id ="ordercard" class="form-control"/></td>
															
														</tr>
													
					<tr>
															<td width="20%" style="text-align: left">Area</td>
															<td width="80%" style="text-align: left"><form:select id="area" path="meter.areaCode"
...
<tr>
															...
															<td width="80%" style="text-align: left"><form:select id="csc" path="meter.csc"
 													 ...
 													 <tr>
															...
															<td width="70%" style="text-align: left"><form:input path="meter.fromto" id ="locationsin" class="form-control"/></td>
															
														</tr>
														
														<tr>
															<td width="20%" style="text-align: left">Sin Number</td>
															<td width="80%" style="text-align: left"><form:select id="sinnumber" path="meter.filename4"
														...
														<tr>
															...
															<td width="70%" style="text-align: left"><form:input path="meter.totower" id ="accountnumber" class="form-control"/><input
 													...
 													<tr>
															...
															<td width="70%" style="text-align: left"><form:input path="meter.filename2" id ="tariff" class="form-control"/></td>
															
														</tr>
														<tr>
															<td width="20%" style="text-align: left">Demand</td>
															<td width="70%" style="text-align: left"><form:input path="meter.filename5" id ="demand" class="form-control"/></td>
															
														</tr>
 													
 														<tr>
															<td width="20%" style="text-align: left">Contact Details</td>
															<td width="70%" style="text-align: left"><form:input path="meter.filename3" id ="contact" class="form-control"/></td>
														...
														<tr>
															...
															<td width="80%" style="text-align: left"><form:select
																	id="ctratio" path="meter.permitNo" onchange=""  class="form-control">
 													...
 													<tr>
															...
															<td width="80%" style="text-align: left"><form:select multiple="true"
																	id="order" path="meter.req1" onchange=""  class="form-control">
 							...
 							<tr>
																...
																<td width="70%" style="text-align: left"><form:textarea path="meter.reason" rows="5" cols="60" id ="additionalwork" class="form-control"/></td>
 ...
 --%>														 
																...
																<input  type="file" name="file" class="form-control">
        														        														...
        														        														<tr>
														<c:if test="${meter.filename1 != null}">
  																	<td><button type='button' class='button button2' onclick="window.location.href='downloadEMReport?id=${meter.filename1}&seq=1'">Attachment</button></td>
																</c:if> 
																 <c:if test="${meter.filename1 == null}">
  																	<td><button type='button' class='button button2' onclick="window.location.href='downloadEMReport?id=${meter.filename1}&seq=1'">No Attachment</button></td>
																</c:if> 
															...
															<td style="text-align: left"><a
																href=""> <input
																	...
																	name="actionButton" value="Update"  class="form-control"></input></a></td>
														</tr>
