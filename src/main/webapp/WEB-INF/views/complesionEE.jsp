...
function removeRequest(id){
    ...
    function saveCompletion(id){
    	...
    	$.ajax({
			type : 'GET',
			url : "/MMS/completionLine?lineid=" +id +"&cycle="+conceptCycleValue+"&complesion="+complesion+"&remarks="+encodeURIComponent(remarks),
			data : {},
			contentType : "application/json; charset=utf-8",
			success : function(data) {
    ...
    function sendNortification(){
    	...
    	$.ajax({
			type : 'GET',
			url : "/MMS/sendNortificationForCompletion?cycle="+conceptCycleValue+"&area="+encodeURIComponent(area),
			data : {},
			contentType : "application/json; charset=utf-8",
			success : function(data) {
...
<div class="upnew">
            	<div class="wrapper">
			<div class = "form">
													<form:form method="post" action="complesionSEE"
				...
				<tr>
														...
														<tr>
															...
															<td width="70%" style="text-align: left"><form:select
																	id="area" path="gldeptobj.deptId" onchange="" 
																	style="width:50%; background-color: #FFFFF; border-radius: 5px;">
																	<form:option value="NONE" label="ALL" />
														...
														<td width="30%" style="text-align: left">Cycle</td>
															<td width="70%" style="text-align: left"><form:select
																	id="cycle" path="cycleObj.id.cycleId" onchange="this.form.submit()" style="width:50%; background-color: #FFFFF; border-radius: 5px;">
																	<form:option value="NONE" label="ALL" />
...
<%--     <table id= "myTable" class="display table" width="100%">
        ...
        <c:set var="count" value="0" scope="page" />
															 ...
															 <c:forEach var="line" items="${model.comList}"  varStatus="status">
																...
																<td>${line.code}</td>
											                 	...
											                 	<td><select id="completion_${line.id}"
																	onchange="" >
																	<c:choose>
                                                                                    <c:when test="${line.complesion=='1'}">
                                                                                        <option value="${line.complesion}"
 																...
 																<td><input type="text" id="remarks_${line.id}" value ="${line.remarks}" class="form-control"></td>
											                 	 <td><button id = "saveBtn_${line.id}"  type="button" class="button button3" onClick=''><i class="glyphicon glyphicon-floppy-disk"></i></button></td> 
     ...
     <div>
    <button type="button" class="button button2" onClick='sendNortification()'>Send Notification</button> 
 </div>
