													...
													<div class="drop-down-padding">
														<div class="col-xs-12" align="right">
															<form:select id="province" path="glcompmobj.compId"
																onchange="findArea()" style="width:100%">
													...
													<div class="drop-down-padding">
														<div class="col-xs-12" align="right">
															<form:select id="area" path="gldeptobj.deptId"
																onchange="getLine()" style="width:100%">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-hover"
											...
											<c:forEach var="summary" items="${model.summaryList}" varStatus="status" >
										...
										<tr>
												...
												<td style="font-size: 10px; text-align:left" ><a href="viewDD">
														View More Divisional Information
													</a></td>
								...
								<!-- <div class="col-lg-3 col-sm-8 col-xs-12">
									<div class="wrimagecard wrimagecard-topimage">
										<div class="wrimagecard-topimage_header"
											...
											<center>
												<i class="fa fa-cubes" style="color: #B22222"></i>
											</center>
											<h4>
