...
function drawDashboard() {
	...
	//document.getElementById("btnReject").disabled = true;
	 ...
	 // alert("hii");
   	  $.ajax({
			type : 'GET',
			url : "/MMS/countValueJournalDetailCount",
			data : {},
			...
			success : function(result) {
				...
				datavaluepie.addColumn('number', 'Journal Count');
				datavaluepie.addColumn('string', 'Dept Id');
				
				for (var i = 0; i < result.sumList.length; i++) {
					var journal = result.sumList[i];
					datavaluepie.addRows([[journal.mitfin_dept_nm,journal.approval_count,journal.mitfin_dept_id]]);
				}
		        ...
		        */ 
		        ...
		        function selectHandler() {
		         ...
		         if(selectedItem){
		        	...
		        	var docNo = table.getDataTable().getValue(row, 2);
 		            estimateNoGloble = docNo;
 		            //costCenterNoGloble = costCenterNo;
 		            
 		           $.ajax({
 		  			type : 'GET',
 		  			url : "/MMS/countValueJournalDetail?deptId="+docNo,
 		  			data : {},
 		  			contentType : "application/json; charset=utf-8",
 		  			success : function(result) {
 						...
 						datavaluepie.addColumn('boolean', 'Recommendation');
 				      ...
 				      function selectHandler() {
	    		         ...
	    		         if(selectedItem){
	    		        	...
	    		        	var isReccomended = table.getDataTable().getValue(row, 8);
	    		        	var isApproved = table.getDataTable().getValue(row, 9);
	    		            
	    		            estimateNoGloble = estimateNo;
	    		            document.getElementById("txtEstNo").value = estimateNo;
	    		            document.getElementById("txtIsApproved").value = isApproved;
	    		            document.getElementById("isReccomended").value = isReccomended;
								...
								<div class="col-sm-6 col-xs-12">
										<div class="wrimagecardNew1 wrimagecard-topimage">
											<div class="wrimagecard-topimage_header"
												...
												<strong>Please select ceb branch</strong>
													<div id="dashboard_div">
      <!--Divs that will hold each control and chart-->
										...
										<div class="wrimagecardNew1 wrimagecard-topimage">
											<div class="wrimagecard-topimage_header"
												style="background-color: #a1d0d0; border-radius: 5px;">
															...
															<strong>Value Journal Approval Summary</strong>
