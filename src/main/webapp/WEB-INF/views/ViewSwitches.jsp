							...
							<div class="row">
								<div class="col-lg-12">		                                    
				                        <div class="col-lg-9">
				                            <ol class="breadcrumb">
				                                <li><a href="#">Home</a></li>
				                                <li class="active"><span>Switches   </span></li>
				                            </ol>
				                        </div>
											...
											<div class="col-lg-12">
												<div class="main-box clearfix">
													<header class="main-box-header clearfix">
														<h2 class="pull-left">Switches   </h2>
													</header>
													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
                												...
                												<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='' />" > Auto Recloser</a></td>
        														    
        														</tr>
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='' />" >LBS</a></td>
        														
        														</tr>
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='' />" >Isolators</a></td>
