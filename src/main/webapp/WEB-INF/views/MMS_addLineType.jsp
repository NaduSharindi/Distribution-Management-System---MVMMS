						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<form:form role="form" method="post" action="MMSAddLinetype" modelAttribute="MmsAddlinetype" onsubmit="return validateForm()">
										...
										<div class="form-group">
											...
											<form:input path="lineType" type="text" class="form-control" id="txtLineName" placeholder="Enter Line Type"/>
										...
										<div class="form-group">
											<div class="pull-left">
												...
												<button type="button" class="btn btn-warning" onclick="window.location.href='editLineType'">Edit</button>
											</div>
										</div>
									</form:form>
								</div>
								...
								<div class="col-lg-12">
									<div class="main-box clearfix">
										<header class="main-box-header clearfix">
											<h2 class="pull-left">Line Types List</h2>
										</header>
