			...
			<div class="row">
				...
				<div class="col-lg-12">		                                    
                        <div class="col-lg-9">
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li class="active"><span>MANAGE INTERRUPTION CYCLE</span></li>
                            </ol>
						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<form:form role="form" method="post" action="MMSAddIntCycle" modelAttribute="MmsCycle" onsubmit="return validateForm()">
										...
										<div class="form-group">
											<div class="pull-left">
												...
												<button type="button" class="btn btn-warning" onclick="window.location.href='editIntCycle'">Edit</button>
											</div>
										</div>
									</form:form>
								</div>
