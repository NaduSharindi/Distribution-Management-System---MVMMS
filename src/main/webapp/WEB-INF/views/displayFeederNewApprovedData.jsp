						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									...
									<form:form role="form" action="MMSupdateFeederApprovedData" method="post" modelAttribute="UpdateFeeder">
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="feeder.gpsLatitude" type="number" value ="0" min="0" step="0.00000001" class="form-control" id="txtGPSLatitude" placeholder="Enter GPS Latitude"/>
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="feeder.gpsLongitude" type="number" value ="0" min="0" step="0.00000001" class="form-control" id="txtGPSLongitude" placeholder="Enter GPS Longitude"/>
