...
<div class="content">
  <form action="#">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter Report number" required>
          </div>
            <div class="input-box">
    ...
    <div class="user-details">
       ...
       <div class="input-box2">
        ...
        <div class="input-box2">
            ...
            <label>Actual</label>
            <input type="time" placeholder="Actual" required>
            <label>Meter</label>
            <input type="time" placeholder="Meter" required>
            </div>
       ...
       <div class="input-box2">
        ...
        <div class="input-box2">
            ...
            <label>Actual</label>
            <input type="date" placeholder="Actual" required>
            <label>Meter</label>
            <input type="date" placeholder="Meter" required>
            </div>
         <div class="input-box2">
...
<button type="button" class="collapsible">CT Ratio Details</button>
<div class="content">
<form action="#">
    <div class="user-details">  
  ...
  <form action="#">
        <div class="user-details">
         ...
         <div class="input-box">
          ...
          <div class="input-box">
            <span class="details">System Date</span>
