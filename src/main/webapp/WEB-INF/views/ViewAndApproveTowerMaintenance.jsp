...
<head>
	...
	function save(id) 
    {
	   ...
	   var baseconcretestatus = document.getElementById("anticlimbingstatus"+id).value;
	   alert('anticlimbingstatus'+anticlimbingstatus);
	...
	/*  var url = "/MMS/updateLine/"+nooftappings+"/"+pinpole1+"/"+switchdev1+"/"+pinpole2+"/"+switchdev2+"/"+pinpole3+"/"
	 +switchdev2+"/"+noofmissingparts+"/"+nofflashoversets+"/"+wayleavestatus+"/"+"/"+baseconcretestatus+"/"
	 +anticlimbingstatus+"/"+conductorstatus+"/" +jumperstatus+"/"+earthconductorstatus+"/" +attentionstatus+"/"
	 +fungussetno+"/"+wpinset+"/" +endfittingset+"/"+towerspecial+"/"+ludt+"/" +maintenancedate+"/";
