...
function getSwitchByFeederIdAR(){
	...
	var strType = 1;
		   ...
		   $.ajax
	         ({
	                 type: 'GET',
	                 url: "/MMS/findSwitchByFeederIdApproval/"+strFeeder+"/"+strType+"/",
	                 data: {},
	                 contentType: "application/json; charset=utf-8",
	                 success: function(response) 
	                 {   
     ...
     ({
             ...
             success: function(response) 
             {
                 ...
                 for (var i = 0; i < response.length; i++) {
                     ...
                     document.getElementById("txtIVoltage").value = item.voltage;
                 }
             }
      });
								   ...
								   <c:if test="${SUCCESS_MESSAGE != null}">
									...
									<div class="tab">
											...
											<div id="Auto" class="tabcontent">
  											<h1>Auto Recloser</h1>
  											<form:form role="form" enctype="multipart/form-data" action="MMSupdateSwitchApprove" method="post" modelAttribute="UpdateSwitch">
									         ...
									         <table class="table table-responsive" id="tblProvinces">
									           <tbody>
									                           ...
									                           <tr>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="switches.voltage" type="number" step="any" class="form-control" id="txtIVoltage" placeholder="Enter Name"/>
									         ...
									         <table class="table table-responsive" id="tblProvinces">
									           <tbody>
									                           ...
									                           <tr>
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="switches.sgSccLevelOfEquipment" type="number" value ="0" min="0" class="form-control" id="txtSCClevelofequipmentLBS" placeholder="Enter SCC level of equipment (kA)"/>
										...
										<div class="form-group">
											...
											<div id="ABS" class="tabcontent">
 											<h1>ABS</h1>
  											<form:form role="form" action="MMSupdateSwitchApprove" method="post" modelAttribute="UpdateSwitch">
