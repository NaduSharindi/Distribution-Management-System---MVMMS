							...
							<div class="row">
								<div class="col-lg-12">		                                    
				                        <div class="col-lg-9">
				                            <ol class="breadcrumb">
				                                <li><a href="#">Home</a></li>
				                                <li class="active"><span>Special observations</span></li>
				                            </ol>
				                        </div>
											...
											<div class="col-lg-12">
												<div class="main-box clearfix">
													<header class="main-box-header clearfix">
														<h2 class="pull-left">Special observations</h2>
													</header>
													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
																...
																<tbody>
																<form:form  method="post" action="ColdlineCivil" modelAttribute="model">
																 <table class="table table-responsive" id="tblProvinces">
