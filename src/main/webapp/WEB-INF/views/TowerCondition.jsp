        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="item-1-1-tab" data-toggle="tab" role="tab" aria-controls="item-1-1" aria-selected="true" href="#item-1-1" >Tower Maintenance Details&gt;</a></li>
                     <li class="nav-item"><a class="nav-link" id="item-1-2-tab" data-toggle="tab" role="tab" aria-controls="item-1-2" aria-selected="false" href="#item-1-2">Tower Image&gt;</a></li>
                        ...
                        <div class="table-responsive" style="padding: 47px;">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr></tr>
                                    <tr>
                                        <td style="font-size: 24px; color: #BC576F;">Tower Information<br></td>
                                        <td></td>
                                    </tr>
...
<tr>
                                  	...
                                  	<tr>
														<td>Tapping</td>
													<td><form:input
																path="mnt.nooftappings" type="number"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Tapping"  /> 
													</td>	
														</tr>
                                     <tr>
														<td>Number of Pin Pole 1</td>
													<td><form:input
																path="mnt.pinpole1" type="number"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Tapping"  /> 
													</td>	
														</tr>
														<tr>
														<td>Switching Device 1</td>
													<td><form:input
																path="mnt.switchdev1" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Tapping"  /> 
													</td>	
														</tr>
														 ...
														 <tr>
														<td>Number of Pin Pole 2</td>
													<td><form:input
																path="mnt.pinpole2" type="number"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Tapping"  /> 
													</td>	
														</tr>
														<tr>
														<td>Switching Device 2</td>
													<td><form:input
																path="mnt.switchdev2" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Tapping"  /> 
													</td>	
														</tr>
														 ...
														 <tr>
														<td>Number of Pin Pole 3</td>
													<td><form:input
																path="mnt.pinpole3" type="number"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Tapping"  /> 
													</td>	
														</tr>
                                    <tr>
														<td>Switching Device 3</td>
													<td><form:input
																path="mnt.switchdev1" type="text"  class="form-select" aria-label="Default select example" style="width:300px; color: gray; border-bottom-color: #BC576F; border-bottom-width: 2px; background-color: #FEEFEC; "
																id="txtEquipmentId"
																placeholder="Tapping"  /> 
