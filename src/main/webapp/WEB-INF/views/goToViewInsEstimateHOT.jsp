...
<body>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="col-lg-9">
								<ol class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active"><span>HOT LINE ESTIMATE</span></li>
								</ol>
							</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="main-box clearfix">
								...
								<!-- <h2 class="pull-left">
									<strong>HOT LINE ESTIMATE</strong>
								</h2> -->
								</header>
								...
								<div class="main-box-body clearfix">
									<div class="table-responsive">
										<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" action="goToViewInsEstimateSHOT"
 ...
 --%>
																...
																<c:forEach var="Line" items="${model.lineListEdit}">
																	<tr>
																		<td><form:checkbox id="cb_${Line.id}" onclick=""
																			...
																			<td><input type="text" id="code_${Line.code}"
													...
													<c:if test="${canGO =='3'}">
														<!-- <br>
														<h2 class="pull-left">
															<strong>MAINTENANCE ESTIMATE</strong>
														</h2>
														<br>
														<br>
														 --><table class="table table-striped table-bordered table-sm " id="tblAdmin">
															<tbody>
															<tr>
															<td>MAINTENANCE ESTIMATE for   ${model.cycle}</td>
																...
																<tr>
																	<td width="40%" style="text-align: left">Total Number of Defective Insulator Sets</td>
																	<td width="60%" style="text-align: left"><form:input
																			path="inspection.totalNoTowers"
																			value="${totalDefTotal}" readonly="true"></form:input>

																	</td>
																</tr>
																
																<%-- <tr>
																	<td width="40%" style="text-align: left">Total of Flash Over Insulators</td>
																	<td width="60%" style="text-align: left"><form:input
																			path="inspection.totalNoTowers"
																			value="${totalIndTotal}" readonly="true"></form:input>
...
<!-- 			<tr>
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
    <td>Total Maintenance Estimate   </td>
    <td></td>
   </tr>
