	...
	function showStatusTypes()
		{
             ...
             ({
                     type: 'GET',
                     url: '/MMS/findAllStatusTypes/',
                     data: {},
                     contentType: "application/json; charset=utf-8",
                     success: function(response) 
                     {
                    	 $("#tblStatusTypes > tbody:last").children().remove();
                         ...
                         for (var i = 0; i < response.length; i++) {
                             ...
                             tr = $('<tr/>');
                                ...
                                $('#tblStatusTypes').append(tr);
                         }
                         
                         $('#tblStatusTypes').dataTable({
                                'info': false,
                                'pageLength': 10,
                                retrieve: true
                            });
		...
		function validateForm() {
		    ...
		    try {
		    	 ...
		    	 if (validateEmpty("txtStatusType") == false) {
	                 throw 1001;
	             }
				...
				if (e == 1000) {
	                document.getElementById("spnId").innerHTML = "Status Type Id is Required !";
	                ScrollToElement("spnId");
	            }
				
				if (e == 1001) {
	                document.getElementById("spnStatusType").innerHTML = "Status Type is Required !";
	                ScrollToElement("spnStatusType");
	            }
				
				if (e == 1002) {
	                document.getElementById("spnStatus").innerHTML = "Status Type Status is Required !";
		 ...
		 function clearErrorMessages() {
	         ...
	         document.getElementById('spnStatusType').innerHTML = "";
	         document.getElementById('spnStatus').innerHTML = "";
	     }
	</script>
</head>
<body onload="showStatusTypes()">
				...
				<div class="row">
					<div class="col-lg-12">		                                    
	                        <div class="col-lg-9">
	                            <ol class="breadcrumb">
	                                <li><a href="#">Home</a></li>
	                                <li class="active"><span>Status Type</span></li>
	                            </ol>
	
	                            <h1>Add Status Type</h1>
	                        </div>
						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<form:form role="form" method="post" action="MMSAddStatusType" modelAttribute="SaveStatusType" onsubmit="return validateForm()">
										...
										<div class="form-group">
											<label for="txtStatusType">Type :
											<form:input path="type" type="text" class="form-control" id="txtStatusType" placeholder="Enter Status Type"/>
											<span id="spnStatusType" class="label label-danger"></span></label>
										</div>
								...
								<div class="col-lg-12">
									<div class="main-box clearfix">
										<header class="main-box-header clearfix">
											<h2 class="pull-left">Status Types List</h2>
										</header>
										
										<div class="main-box-body clearfix">
											<div class="table-responsive">
                                              <table class="table table-responsive" id="tblStatusTypes">
