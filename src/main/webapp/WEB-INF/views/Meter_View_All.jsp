    ...
    <table id= "myTable" class="display table" width="100%">
       ...
       <th>Location</th>
        ...
        <c:set var="count" value="0" scope="page" />
									...
									<%-- <c:if test="${email.filename1 == null}">
  	<td><button type='button' class='button button2' onclick="window.location.href='downloadIntImgReq?id=${email.filename1}&seq=1'">No Attachment</button></td>
									  ...
									  <c:if test="${email.filename1 != null}">
																...
																<td><button type="button" onClick='openPopupSubmitImg1("${email.approvalId}")' class="button button2" ><i class="glyphicon glyphicon-folder-open"></i></button> 
																</td>
