													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
                												...
                												<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/ViewScheduleAndReport?mode=EWOP' />" >Electrical works on poles</a></td>
        														    
        														</tr>
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/ViewScheduleAndReport?mode=VR' />" >Vegetation schedule</a></td>
        														
        														</tr>
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='ViewScheduleAndReport?mode=MP/' />" >Missing parts schedule</a></td>
