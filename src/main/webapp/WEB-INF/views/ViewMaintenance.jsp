													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
                												...
                												<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/viewLine' />" >Gantry Maintenance</a></td>
        														    
        														</tr>
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/viewSupport' />" >Switch Maintenance </a></td>
        														
        														</tr>
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/viewTLMaintenance' />" >Tower Line Maintenance </a></td>
