					...
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-9">
								<ol class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active"><span>${submitType} Action</span></li>
								</ol>
							</div>
													   ...
													   <table class="table table-striped table-bordered table-sm " id="tblAdmin">
														...
														<%-- <c:when test="${submitType=='Interruption'}">
															...
															<!-- <th></th>
															 -->
															 <tr>
															<td>Interruption Request No</td>
															<td>${intRequestObj.approvalId}</td>
...
<c:when test="${submitType=='WayLeave'}">
																...
																<tr>
																<td><button type='button' class='btn btn-warning' onclick="window.location.href='ViewProvincialScheduleAE?mode=VR'" title ='View WayLeave Report'><i class="fa fa-check"></i></button></td>
...
<c:when test="${submitType=='Interruption'}">
																...
																<tr>
																<td style="background-color:#BEBEBE;">Interruption Request No</td>
															    <td style="background-color:#BEBEBE;">${email.approvalId}</td></tr><tr><td></td>
															    <td>
															
															<div class="btn-group">
  <button type='button' onclick="window.location.href='downloadInterruptionReq?id=${email.approvalId}'" title ='View Letter'>View Letter</button>
  
  <c:if test="${email.filename1 != null}">
  																	<button type='button' onclick="window.location.href='downloadIntImgReq?id=${email.filename1}&seq=1'" title ='View Image'>View Image</button>
																</c:if>
																...
																<%-- <td><button type='button' class='btn btn-info' onclick='loadNetwork("${email.approvalId}")'><i class="fa fa-check"></i></button></td>
																 --%>
																</tr>
																<tr>
																<%-- <td style="text-align:center"><input style="text-align:center" type="text" id="" value="${email.approvalId}"  class="form-control" disabled></td>
																...
																<tr>
																 <td>Action</td>
																<input style="text-align:center" type="hidden" id="id_${email.approvalId}" value="${email.approvalId}"  class="form-control" disabled>
																
																<td style="text-align:left"> <select id="action_${email.approvalId}" class="form-control"  onclick='enableResheduleDate("${email.approvalId}")' >
																...
																<tr>
																<td></td>
																<td><button type='button' class='btn btn-info' onclick='actionTaken("${email.approvalId}")' title ='OK'><i class="fa fa-check"></i></button></td>
																 ...
																 <td style="text-align:center"><input style="text-align:center" type="date" id="datepicker1_${email.approvalId}"  class="form-control" disabled></input></td>
																</tr>
																<tr>
																<td>Alternative Supply Arrangement</td>
																<td style="text-align:left"><textarea rows="3" cols="50" id="altsup_${email.approvalId}" ></textarea></td>
																</tr>
																<tr>
																...
																<!--  <tr>
																 <td>Description : </td>
																 <td><textarea rows="5" cols="120" disabled>Generated Date & Time : ${email.approvedDate} ${email.approvedTime} Forwarded Date & Time : ${email.forwardDate} ${email.forwardedTime} Section to be interrupted : ${email.fromto} Time Duration: ${email.timeduration} Requested EE/ES :${email.reason} Field Work : ${email.req2}</textarea> </td>
																</tr>
																 --><tr>
																<td>Forwarded Date & Time</td>
																 
																<td>${email.forwardDate} ${email.forwardedTime}</td>
																</tr>
																 - <tr>
																<td>Section to be interrupted</td>
																<td>${email.fromto}</td>
																</tr> 
																 <tr>
																<td>Time Duration</td>
																...
																<td style="text-align:left"><textarea rows="3" cols="60" class="form-control" disabled>${email.req1}</textarea></td>
																<td style="text-align:left"><textarea rows="3" cols="60" class="form-control" disabled>${email.req2}</textarea></td>
																 <td style="text-align:left"> <form:select id="incharge_es_${email.approvalId}" path="intRequestObj.inchargeEs" class="form-control" >
																...
																<td><button type='button' class='btn btn-info' onclick='loadNetwork("${email.approvalId}")'>Network View</button></td>
																 ...
																 --%><tr>
																<td> <img src="${sessionScope.reportpath}/Reports/outgoingright.png"/>
																
																<iframe src="${sessionScope.reportpath}/Reports//INT-600.42-0002.pdf" style="width:600px; height:500px;" frameborder="0"></iframe>
																</tr>
