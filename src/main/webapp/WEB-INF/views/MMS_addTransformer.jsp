			...
			<div class="row">
				...
				<div class="col-lg-12">		                                    
                        <div class="col-lg-9">
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li class="active"><span>Transformer</span></li>
                            </ol>
						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<form:form role="form" action="MMSaddTransformer" method="post" modelAttribute="SaveTransformer">
																...
																<form:select path="" onchange="findArea()" class="form-control" id="cmbSelectProvince" name="cmbSelectProvince">
																   <form:options items="${SaveTransformer.provinceList}" /> 
																</form:select>
																...
																<form:select path=""  onchange="getLine()" class="form-control" id="cmbSelectArea" name="cmbSelectArea">
																     <form:options items="${SaveTransformer.areaList}" />
																</form:select>
																...
																<form:select path="" onchange="getGantryByAreaLine()" class="form-control" id="cmbSelectLineId" name="cmbSelectLineId">
																      <form:options items="${SaveTransformer.lineList}" />
																</form:select>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="" type="text" class="form-control" id="txtIDT" placeholder="Enter ID"/>
																<span id="spnIDT" class="label label-danger"></span>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="" type="text" class="form-control" id="txtBrandT" placeholder="Enter Brand Name"/>
																<span id="spnBrandT" class="label label-danger"></span>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="" type="text" class="form-control" id="txtModelT" placeholder="Enter Model"/>
																<span id="spnModelT" class="label label-danger"></span>
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="" type="number" value ="0" min="0" class="form-control" id="txtSerialNoT" placeholder="Enter Serial No"/>
																<span id="spnSerialNoT" class="label label-danger"></span>
																</td>    
        														</tr>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="" type="date" class="form-control" id="txtDateT"/>
																<span id="spnDateT" class="label label-danger"></span>
                												...
                												<td width="70%" style="text-align:left">
																<form:input path="" type="date" class="form-control" id="txtCDateT"/>
																<span id="spnCDateT" class="label label-danger"></span>
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="" type="number" value ="0" min="0" class="form-control" id="txtKVAT" placeholder="Enter KVA"/>
																<span id="spnKVAT" class="label label-danger"></span>
																</td>    
        														</tr>
                												...
                												<td width="70%" style="text-align:left">
                												<form:input path="" type="number" value ="0" min="0" class="form-control" id="txtVoltageratioT" placeholder="Enter Voltage Ratio"/>
																<span id="spnVoltageratioT" class="label label-danger"></span>
																</td>    
        														</tr>
