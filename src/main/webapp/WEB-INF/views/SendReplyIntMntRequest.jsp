...
function createConnetionType(){
	var contype = conType.options[conType.selectedIndex].value;
	var x = document.getElementById("ordercardNumber").value;
	
	var urlStr = "/MMS/getNextTestingId?prefix="+ contype +"&order="+x;
	alert(urlStr);
	$.ajax({
			type : 'GET',
			url : "/MMS/getNextTestingId?prefix="+ contype +"&order="+x,
			data : {},
			contentType : "application/json; charset=utf-8",
			success : function(data) {
				alert('hiii');
				document.getElementById("reportNumber").value = data;
				alert(data);
			}
		});	
}
  ...
  <br>
	...
	<form:form method="post" enctype="multipart/form-data" action="MeterTRSave"	modelAttribute="model">
						 <div class="user-details">
						  <div class="input-box">
            <span class="details">Order Card Number:</span>
              <form:input type="text" path="meter.approvalId" id ="ordercardNumber" placeholder="Auto Get data from relevant order card?"/>
            </div>
         ...
         <div class="input-box2">
          ...
          <form:input path="meter.fromto" id ="locationsin" /></div>
           ...
           <!--  <div class="input-box2">
            ...
            <select class ="drop-down">
                ...
                <option value="AE">Area</option>
            </select> 
          </div>
          <div class="input-box">
            <span class="details">Connection Type</span>
            <form:select id ="conType" path = "conType" onchange="createConnetionType()" class ="drop-down">
          ...
          <div class="input-box">
            ...
            <select class ="drop-down">
                 <option value="SNP">New meter Installation- Solar Net Plus</option>
                 <option value="HRM">Harmonic Test - Bulk</option>
                <option value="RTN">Routine</option>
                <option value="NCO">New connection</option>
                 <option value="CPA">Capacity Augment</option>
                <option value="MCH">Meter change</option>
                <option value="AER">AEE Request</option>
                <option value="AUD">Audit</option>
            </select> 
          </div>
          <div class="input-box">
            <span class="details">Report Number</span>
            <form:input type="text" id ="reportNumber" path ="" placeholder="Auto generated though system:"></form:input>
          </div>
            <div class="input-box">
          ...
          <div class="input-box">
            <span class="details">Upload Test Report 1</span>
           <input  type="file" name="file3" class="form-control">
																</div>
          <div class="input-box">
            <span class="details">Upload Test Report 2</span>
           <input  type="file" name="file3" class="form-control">
																</div>
        ...
        <form:input type="submit" class="button3" value="Save" path="Save"></form:input>
