													...
													<div class="main-box-body clearfix">
														<div class="table-responsive">
			                                              <table class="table table-responsive" id="tblProvinces">
                												...
                												<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/viewPHMSchedule' />" >PHM Branch schedules</a></td>
        														    
        														</tr>
        														<tr>
                													<td  style="text-align:left"   ><a href="<c:url value='/viewProvinceSchedules' />" >Provincial schedules</a></td>
