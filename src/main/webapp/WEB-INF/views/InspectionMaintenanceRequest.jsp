...
<body onload="myMap(new google.maps.LatLng(7.475214, 80.744077), 7);viewMapByMode();">
								...
								<div class="main-box-body clearfix">
									<!-- <div class="table-responsive">
									 -->	<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" enctype="multipart/form-data" action="goToInsMntRequestS"	modelAttribute="model">
 ...
 <tr><div id="map_container"></div>
												 ...
												 <tr>
															<td width="20%" style="text-align: left">View</td>
															<td width="80%" style="text-align: left"><form:select path="" class="form-control" id="modeType" >
															...
															<%-- <td width="70%" style="text-align: left"><form:select id="modeType" path="" style="width:100%; background-color: #fff981; border-radius: 5px;">
																<form:option value="NETWORK" label="NETWORK VIEW" />
 ...
 --%>														</tr>
														...
														<tr>
															...
															<td width="80%" style="text-align: left"><form:select id="area" path="gldeptobj.deptId"
																onchange="getLine()" class="form-control">
 ...
 <tr>
														...
														<%-- <tr>
															<td width="20%" style="text-align: left">Branch</td>
															<td width="80%" style="text-align: left"><form:select
																	id="Branch" path="releventBranch" onchange="" class="form-control">
																	<form:option value="600.41" label="PHM - LCM" />
																	<form:option value="600.42" label="PHM - SUB" />
																	
																</form:select></td>
														</tr>
														 --%> 
														 <c:if test="${model.mode=='PHM'}">
														 <tr>
														 ...
														 <c:if test="${model.mode=='INS'}">
														 <tr>
															<td width="20%" style="text-align: left">Responsible EE</td>
															<td width="80%" style="text-align: left"><form:select
																	id="userIdEE" path="sausermEE.userId" onchange=""  class="form-control">
 ...
 <tr>
																<td width="30%" style="text-align: left">Requesting Section to be inspected</td>
																<td width="70%" style="text-align: left"><form:textarea path="mailContent" rows="5" cols="60" id ="mailContent1" class="form-control"/></td>
 ...
 <tr>
																<td width="30%" style="text-align: left"><form:label
																	path="">Applicant</form:label></td>
																<td width="70%" style="text-align: left"><form:select id="userId" path="applicant.idNo" class="form-control"  style="background-color: #94cb71; border-radius: 5px;">
																...
																<tr>
																<td width="30%" style="text-align: left"><form:label
																	path="">ES</form:label></td>
																<td width="70%" style="text-align: left"><form:select id="userId" path="sauserm.userId" class="form-control"  style="background-color: #94cb71; border-radius: 5px;">
 	 ...
 	 --%>
 																<tr>
																<td width="20%" style="text-align: left">Requirement</td>
																	<td width="80%" style="text-align: left"><form:textarea path="mailContent2" rows="5" cols="60" id ="mailContent2" class="form-control" /></td>
															...
															<td style="text-align: left"><a
																href=""> <input
																	...
																	name="actionButton" value="Generate" onclick="" class="form-control"></input></a></td>
														</tr>
