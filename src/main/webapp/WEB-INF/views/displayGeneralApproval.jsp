						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									...
									<form:form role="form" enctype="multipart/form-data" action="MMSupdateGeneralApproval" method="post" modelAttribute="UpdateGeneral">
										...
										<div class="form-group">
											...
											<c:if test="${sessionScope.loggedUserRole =='ES' || sessionScope.loggedUserRole =='DEO' }">
												...
												<input type="submit" Value="Validate" class="btn btn-success" class="form-control"/>
												</c:if>
												<c:if test="${sessionScope.loggedUserRole =='EE'}">
					
												<input type="submit" Value="Approve" class="btn btn-success" class="form-control"/>
												</c:if>
