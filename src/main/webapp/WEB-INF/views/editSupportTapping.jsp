          ...
          //edit anushka 2019-01-02------------------------------------------------------------------------------------------------------------------------
        	function saveAll() {
        		...
        		for (var count = 0; count < len; count++) {
        			...
        			var n = 'PHMR2ES1';
        			var url = "/MMS/updateSupportTapping/" + c + "/"+ a + "/" + pid + "/" + d + "/" + e
					+ "/" + f + "/" + g + "/" + h + "/" + i + "/" + j + "/" + k
					+ "/" + l + "/" + m + "/" + t + "/" + x + "/" + status
					+ "/" + n;
...
var t = document.getElementById("t30_" + pid).value;
               ...
               // alert( "sType: " + a + " / id: " + pid + " / area: " + d + " / csc: " + e + " / cType: " + f + " / ecType: " + g + " / tType: " + h + " / tConfig: " + i + " / gpsLat: " + j + " / gpsLon: " + k + " / nofCir: " + l + " / bExten: " + m + " / tapping: " + t + " / mapId: " + x + " / status: " + status + " / appLevel: " + n );
                ...
                var url = "/MMS/updateSupportTapping/" + c + "/"  + a + "/" + pid + "/" + d + "/" + e + "/" + f + "/" + g + "/" + h + "/" + i + "/" + j + "/" + k + "/" + l + "/" + m + "/" + t + "/" +x +"/" +status + "/" + n;
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table class="table table-responsive" id="tblProvinces">
                                                ...
                                                <tbody>
                                                    <form:form method="post" action="displaySupportTappingS" modelAttribute="model">
