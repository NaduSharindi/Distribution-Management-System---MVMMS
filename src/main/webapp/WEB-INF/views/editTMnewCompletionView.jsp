...
function editAll(stringIDs) {
	...
	for (var count = 0; count < len; count++) {
        ...
        var conceptCycleValue = document.getElementById("cycleno_"+id).value;
        		...
        		var url = "/MMS/updateTowerMaintenceCompletion/" + conceptCycleValue + "/" + id
     ...
     var url = "/MMS/updateTowerMaintenceCompletion/"+conceptCycleValue+"/"+id+"/"+nooftappings+"/"+pinpole1+"/"+switchdev1+"/"+pinpole2+"/"+
    ...
    function sendForValidation()
    {
        ...
        var url = "/MMS/updateTMStatusCompletion/" + province + "/" + area + "/" + line +"/" + conceptCycleValue +"/";
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-9">
								<ol class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active"><span>View Completion Data</span></li>
								</ol>
							</div>
								...
								<div class="main-box-body clearfix">
									<div class="table-responsive">
										<table class="table table-responsive" id="tblProvinces">
											...
											<tbody>
												<form:form method="post" action="mntViewCompletionS"
													...
													<table class="table table-responsive" id="tblProvinces">
														...
														<tr>
															...
															<td width="70%" style="text-align: left"><form:select
																	...
																	onchange="findArea()" style="width:50%; background-color: #8187ff; border-radius: 5px;">
														...
														<tr>
															...
															<td width="70%" style="text-align: left"><form:select
																	id="area" path="gldeptobj.deptId" onchange="getLine()" style="width:50%; background-color: #8187ff; border-radius: 5px;">
																	<form:option value="NONE" label="ALL" />
														...
														<tr>
															...
															<td width="70%" style="text-align: left"><form:select
																	id="line" path="line.code" onchange="" style="width:50%; background-color: #8187ff; border-radius: 5px;">
													...
													<option value="202002"> 202002 </option> -->
                                                        ...
                                                        <table class="table table-responsive" id="tblAdmin">
															...
															<th class="text-center">Fungus Sets</th>
															<th class="text-center">WPIN Sets</th>
															<th class="text-center">End Fitting Sets</th>
															
															<th class="text-center">Way Leave Status</th>
											           ...
											           <c:forEach var="mmsTxtMnt" items="${model.mmsTxtCompletionList}"  varStatus="status">
														<tr>
														  <td><input type="text" id="hotLineMnt_${mmsTxtMnt.id.towerid}" value="${mmsTxtMnt.hotLineMnt}" class="form-control" disabled></td>
															...
															<td><select id="status_${mmsTxtMnt.id.towerid}" class="form-control" disabled>
											                   <c:choose>
                                                                                    <c:when test="${sessionScope.loggedUserRole=='DEO'}">
                                                                                        <option value="${mmsTxtMnt.status}"
                                                                                            selected="selected">In Bulk</option>
                                                                                             ...
                                                                                             <option value="8">Not Completed</option>
                                                                                             <option value="10">Completed & Send for Validation</option>
                                                                                    ...
                                                                                    <c:when test="${sessionScope.loggedUserRole=='ES'}">
                                                                                        <option value="${mmsTxtMnt.status}"
                                                                                            selected="selected">In Bulk</option>
                                                                                            <option value="11">Send for Validation</option>
                                                                                    		
                                                                                    		</c:when>

                                                                                    <c:when test="${sessionScope.loggedUserRole=='EE'}">
                                                                                          <option value="${mmsTxtMnt.status}"
                                                                                            selected="selected">Pending Approval</option>
