		...
		function showConductorTypes()
			{
	             ...
	             ({
	                     type: 'GET',
	                     url: '/MMS/findAllEarthConductorTypes/',
	                     data: {},
			...
			function validateForm() {
			    ...
			    try {
					...
					if (e == 1000) {
		                document.getElementById("spnId").innerHTML = "Earth Conductor Type Id is Required !";
		                ScrollToElement("spnId");
		            }
					
					if (e == 1001) {
		                document.getElementById("spnConductorName").innerHTML = "Earth Conductor Type is Required !";
		                ScrollToElement("spnConductorName");
		            }
					
					if (e == 1002) {
		                document.getElementById("spnStatus").innerHTML = "Earth Conductor Type Status is Required !";
			...
			<div class="row">
				...
				<div class="col-lg-12">		                                    
                        <div class="col-lg-9">
                            <ol class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li class="active"><span>Earth Conductor Type</span></li>
                            </ol>

                            <h1>Add Earth Conductor Type</h1>
                        </div>
						...
						<div class="col-lg-6">
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<form:form role="form" method="post" action="MMSAddEarthConType" modelAttribute="SaveEarthConType" onsubmit="return validateForm()">
										...
										<div class="form-group">
											...
											<form:input path="type" type="text" class="form-control" id="txtConductorName" placeholder="Enter Earth Con: Type"/>
										...
										<div class="form-group">
											<div class="pull-left">
												...
												<button type="button" class="btn btn-warning" onclick="window.location.href='editEarthConductorType'">Edit</button>
											</div>
										</div>
									</form:form>
								</div>
								...
								<div class="col-lg-12">
									<div class="main-box clearfix">
										<header class="main-box-header clearfix">
											<h2 class="pull-left">Earth Conductor Types List</h2>
										</header>
                                              ...
                                              <table class="table table-responsive" id="tblConductorTypes">
                                                    ...
                                                    <thead>
														<tr>
															...
															<th class="text-center">Earth Conductor Type</th>
