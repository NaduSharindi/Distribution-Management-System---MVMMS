								   ...
								   <c:if test="${SUCCESS_MESSAGE != null}">
									...
									<div class="tab">
											...
											<div id="Auto" class="tabcontent">
  											<h1>Auto Recloser</h1>
  											<form:form role="form" enctype="multipart/form-data" action="MMSupdateSwitch" method="post" modelAttribute="UpdateSwitch">
										...
										<div class="form-group">
											...
											<div id="ABS" class="tabcontent">
 											<h1>ABS</h1>
  											<form:form role="form" action="MMSupdateSwitch" method="post" modelAttribute="UpdateSwitch">
