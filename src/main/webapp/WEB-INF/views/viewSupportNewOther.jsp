                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table class="table table-responsive" id="tblProvinces">
                                                ...
                                                <tbody>
                                                    <form:form method="post" action="viewSupportNewSOther" modelAttribute="model">
                                                        ...
                                                        <table class="table table-responsive" id="tblProvinces">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="70%" style="text-align:left">
                                                                    ...
                                                                    <form:select id="area" path="gldeptobj.deptId"
                                                                        onchange="getLine()" style="width:50%; background-color: #94cb71; border-radius: 5px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="70%" style="text-align:left">
                                                                    <form:select id="line" path="line.code" onchange="" style="width:50%; background-color: #8187ff; border-radius: 5px;">
