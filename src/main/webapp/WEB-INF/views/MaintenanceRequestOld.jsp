										...
										<h2 class="pull-left">
														...
														<table class="table table-responsive" id="tblAdmin">
															...
															<tbody>
																...
																<td width="40%" style="text-align: left">Requirement</td>
																	<td width="60%" style="text-align: left"><form:textarea path="mailContent" rows="5" cols="60" /></td>
																<td width="40%" style="text-align: left">Requesting section/s to be inspected</td>
																	<td width="60%" style="text-align: left"><form:textarea path="mailContent2" rows="5" cols="60" /></td>
