...
/**
 * The persistent class for the MTREQHTT database table.
 * 
 */
@Entity
@NamedQuery(name="Mtreqhtt.findAll", query="SELECT m FROM Mtreqhtt m")
public class Mtreqhtt implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MtreqhttPK id;
	...
	public MtreqhttPK getId() {
		return this.id;
	}

	public void setId(MtreqhttPK id) {
		this.id = id;
	}
