 ...
 */
@Entity
@NamedQuery(name="Speststd.findAll", query="SELECT s FROM Speststd s")
public class Speststd implements Serializable {
	...
	@Column(name="NBT_PRESENT")
	private BigDecimal nbtPresent;
	...
	@Column(name="SECOND_CIRCUIT_LENGTH")
	...
	@Column(name="TAX_PRESENT")
	private BigDecimal taxPresent;
	...
	public BigDecimal getNbtPresent() {
		return this.nbtPresent;
	}

	public void setNbtPresent(BigDecimal nbtPresent) {
		this.nbtPresent = nbtPresent;
	}
	...
	public BigDecimal getSecondCircuitLength() {
		return this.secondCircuitLength;
	}
	...
	public BigDecimal getTaxPresent() {
		return this.taxPresent;
	}

	public void setTaxPresent(BigDecimal taxPresent) {
