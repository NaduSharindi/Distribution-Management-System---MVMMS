...
/**
 * The persistent class for the MMS_TXNTOWERMAINTENANCE database table.
 * 
 */
@Entity
@Table(name="MMS_TXNTOWERMAINTENANCE")
@NamedQuery(name="MmsTxntowermaintenance.findAll", query="SELECT m FROM MmsTxntowermaintenance m")
