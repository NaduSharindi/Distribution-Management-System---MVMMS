...
/**
 * The persistent class for the CBPMTHTT database table.
 * 
 */
@Entity
@NamedQuery(name="Cbpmthtt.findAll", query="SELECT c FROM Cbpmthtt c")
public class Cbpmthtt implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private CbpmthttPK id;
	...
	public CbpmthttPK getId() {
		return this.id;
	}

	public void setId(CbpmthttPK id) {
		this.id = id;
	}
