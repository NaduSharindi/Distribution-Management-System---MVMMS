...
/**
 * The persistent class for the PCESTHMT database table.
 * 
 */
@Entity
@NamedQuery(name="Pcesthmt.findAll", query="SELECT p FROM Pcesthmt p")
public class Pcesthmt implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PcesthmtPK id;
	...
	public PcesthmtPK getId() {
		return this.id;
	}

	public void setId(PcesthmtPK id) {
		this.id = id;
	}
	...
	public BigDecimal getEstType() {
		return this.estType;
	}

	public void setEstType(BigDecimal estType) {
