...
/**
 * The primary key class for the PCTRXHTT database table.
 * 
 */
@Embeddable
public class PctrxhttPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PctrxhttPK)) {
			return false;
		}
		PctrxhttPK castOther = (PctrxhttPK)other;
		return 
