...
/**
 * The primary key class for the MTREQHTT database table.
 * 
 */
@Embeddable
public class MtreqhttPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MtreqhttPK)) {
			return false;
		}
		MtreqhttPK castOther = (MtreqhttPK)other;
		return 
