...
/**
 * The persistent class for the MMS_ADDLINE database table.
 * 
 */
@Entity
@Table(name="MMS_ADDLINE")
@NamedQuery(name="MmsAddline.findAll", query="SELECT m FROM MmsAddline m")
public class MmsAddline implements Serializable {
	...
	@SequenceGenerator(name = "SeqGen", sequenceName = "LINE2_INSTALL_SEQ", allocationSize = 1)
	@Column(name="ID")
	private long id;
	...
	public String toString() {
		return "MmsAddline [id=" + id + ", approvedBy=" + approvedBy
				+ ", approvedDate=" + approvedDate + ", approvedTime="
				+ approvedTime + ", area=" + area + ", circuitType="
				+ circuitType + ", code=" + code + ", comdate=" + comdate
				+ ", conductorType=" + conductorType + ", csc=" + csc
				+ ", entBy=" + entBy + ", entDate=" + entDate + ", entTime="
				+ entTime + ", feederIdentification=" + feederIdentification
				+ ", feeder2=" + feeder2 + ", length=" + length + ", lineName="
				+ lineName + ", lineType=" + lineType + ", name=" + name
				+ ", noofpoles=" + noofpoles + ", nooftowers=" + nooftowers
				+ ", phmBranch=" + phmBranch + ", sinNo=" + sinNo + ", status="
				+ status + ", type=" + type + ", validateBy=" + validateBy
