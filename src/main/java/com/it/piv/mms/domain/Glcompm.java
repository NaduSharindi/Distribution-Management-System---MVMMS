 ...
 */
@Entity
@NamedQuery(name="Glcompm.findAll", query="SELECT g FROM Glcompm g")
public class Glcompm implements Serializable {
	...
	public String toString() {
		return "Glcompm [compId=" + compId + ", add1=" + add1 + ", add2="
				+ add2 + ", add3=" + add3 + ", add4=" + add4 + ", compNm="
				+ compNm + ", eMail=" + eMail + ", entBy=" + entBy + ", entDt="
				+ entDt + ", fax1=" + fax1 + ", fax2=" + fax2 + ", filter="
				+ filter + ", grpComp=" + grpComp + ", logId=" + logId
				+ ", lvlNo=" + lvlNo + ", modiBy=" + modiBy + ", modiDt="
				+ modiDt + ", parentId=" + parentId + ", status=" + status
				+ ", tel1=" + tel1 + ", tel2=" + tel2 + "]";
	}
