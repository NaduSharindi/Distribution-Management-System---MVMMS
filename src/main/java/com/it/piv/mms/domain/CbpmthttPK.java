...
/**
 * The primary key class for the CBPMTHTT database table.
 * 
 */
@Embeddable
public class CbpmthttPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CbpmthttPK)) {
			return false;
		}
		CbpmthttPK castOther = (CbpmthttPK)other;
		return 
