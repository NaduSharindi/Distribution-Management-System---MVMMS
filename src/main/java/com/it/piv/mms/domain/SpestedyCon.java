...
/**
 * The persistent class for the SPESTEDY_CONS database table.
 * 
 */
@Entity
@Table(name="SPESTEDY_CONS")
@NamedQuery(name="SpestedyCon.findAll", query="SELECT s FROM SpestedyCon s")
public class SpestedyCon implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SpestedyConPK id;
	...
	public SpestedyConPK getId() {
		return this.id;
	}

	public void setId(SpestedyConPK id) {
		this.id = id;
	}
