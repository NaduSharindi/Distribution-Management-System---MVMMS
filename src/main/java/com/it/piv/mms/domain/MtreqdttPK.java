...
/**
 * The primary key class for the MTREQDTT database table.
 * 
 */
@Embeddable
public class MtreqdttPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MtreqdttPK)) {
			return false;
		}
		MtreqdttPK castOther = (MtreqdttPK)other;
		return 
