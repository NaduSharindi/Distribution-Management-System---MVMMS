...
private boolean chkPassworEquality(String M_P, String userName, String webAppName)
			throws Exception {
		//SecurityDaoImpl ejb=new SecurityDaoImpl();
		//String password=ejb.getPassword(userName,webAppName);
...
public static void main(String[] args) throws Exception {
		...
		System.out.println("The authentication is....:"+en.validateLogin("DGM123", "test123", "SMCTesting"));
		System.out.println("The authentication is....:"+en.validateLogin("441CE", "test123", "SMCTesting"));
		System.out.println("The authentication is....:"+en.validateLogin("ES123", "test12", "SMCTesting"));
