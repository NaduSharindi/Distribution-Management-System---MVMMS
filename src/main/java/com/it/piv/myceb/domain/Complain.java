...
public class Complain implements Serializable {
	...
	@SequenceGenerator(name = "SeqGen", sequenceName = "COMPLAIN_SEQ", allocationSize = 1)
	@Column(name="ID")
	private double id;
	...
	@Column(name="RECORDE_USER")
	private String recordeUser;
	...
	public String getRecordeUser() {
		return recordeUser;
	}


	public void setRecordeUser(String recordeUser) {
		this.recordeUser = recordeUser;
	}
