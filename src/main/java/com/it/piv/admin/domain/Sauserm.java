package com.it.piv.admin.domain;
...
public class Sauserm implements Serializable {
	...
	@Column(name="ACESS_AUTH", precision=2)
	...
	@Column(name="CHANGE_FRQ", precision=3)
	...
	@Column(name="LOG_ID", precision=6)
	private BigDecimal logId;

	@Column(name="LOG_STATUS", length=1)
	private String logStatus;

	@Column(name="LOGIN_PRD", precision=1)
	...
	@Column(name="TRXN_AUTH", precision=1)
	...
	@Column(name="VALID_PRD", precision=3)
	private BigDecimal validPrd;

	@Column(name="WARN_PRD", precision=3)
