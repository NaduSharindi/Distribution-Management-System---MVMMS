...
/**
 * The persistent class for the SAUSERM_MMS database table.
 * 
 */
@Entity
@Table(name="SAUSERM_MMS")
@NamedQuery(name="SausermMm.findAll", query="SELECT s FROM SausermMm s")
public class SausermMm implements Serializable {
